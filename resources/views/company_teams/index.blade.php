...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ _trans("Company Teams")  }}</h1>
            <div class="section-header-breadcrumb">
                <a href="{{ route('companyTeams.create')}}" class="btn btn-primary form-btn">{{ _trans("Company Team")  }} <i class="fas fa-plus"></i></a>
            </div>
        </div>
