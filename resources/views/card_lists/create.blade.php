@extends('layouts.app')
@section('title')
    {{ _trans("Create Card Lists")  }}
@endsection
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading m-0">{{ _trans("New Card Lists")  }}</h3>
            <div class="filter-container section-header-breadcrumb row justify-content-md-end">
                <a href="{{ route('cardLists.index') }}" class="btn btn-primary">{{ _trans("Back")  }}</a>
            </div>
        </div>
        <div class="content">
                           ...
                           <div class="card-body ">
                               <form method="post" action="{{ route('cardLists.store') }}" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group col-sm-12">
                                       ...
                                       <a href="{{ route('cardLists.index') }}" class="btn btn-light">{{ _trans("Cancel")  }}</a>
                                   </div>
                               </form>
                           </div>
                       </div>
