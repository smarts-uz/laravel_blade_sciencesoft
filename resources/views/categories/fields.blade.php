...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('name_lang', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('description_lang', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('path_blade', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>
