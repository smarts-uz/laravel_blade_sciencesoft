...
<div class="container mb-24">
  ...
  <div class="platforms px-3 lg:px-16 sm:px-16 py-12">
    <h2 class="text-gray-900 text-2xl mb-4">{{ @translate_lang("PLATFORMS WE WORK WITH")  }}</h2>
    <hr class="w-10 h-1 bg-yellow-600 mb-4"/>
    <p class="w-11/12 text-gray-700 font-light mb-3">
      {{ @translate_lang("Distilling deep tech experience, our experts can help you with
  ...
  <h1 class="px-16 text-3xl py-12">
    <p class="mb-4">{{ @translate_lang("NEED A CONSULTATION?")  }}</p>
    <hr class="w-10 h-1 bg-pink-600">
  </h1>


  <form class="px-16 py-12 bg-gray-200 text-gray-800">
    <label class="">{{ @translate_lang("Drop us a line! We are here to answer your questions 24/7.")  }}</label>
      ...
      <div class="flex flex-col mr-3">
        ...
        <textarea placeholder="{{ @translate_lang("How can we we help you?")  }}" cols="3" rows="6"
         ...
         <div class="flex justify-center items-center mb-3">
          <button type="submit" class="text-center uppercase bg-blue-700 hover:bg-blue-900 text-white w-52 h-12">{{ @translate_lang("Discuss my needs")  }}</button>
         </div>
      </div>
