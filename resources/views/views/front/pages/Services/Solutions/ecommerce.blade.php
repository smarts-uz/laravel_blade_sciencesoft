...
@section('main')
    ...
    <div class="mx-6 md:mx-16 lg:mx-24 my-10">
        ...
        <div class="px-10 md:px-16 mb-10 lg:px-36 flex flex-col justify-center items-center text-center mt-20">
            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-900 font-semibold">{{ @translate_lang("DIGITAL COMMERCE")  }}</h1>
            <hr class="w-20 h-1 bg-yellow-600 my-10 ">
            <p class="text-center text-base sm:text-lg md:text-xl lg:text-2xl leading-10 text-gray-700 ">{{ @translate_lang("At its core,
        ...
        <div class="mx-6 sm:mx-16 lg:mx-18 ">
            ...
            <div class='flex flex-row flex-wrap justify-evenly'>
                <div
                    ...
                    <div class="p-5 text-center font-bold text-xl mb-2">{{ @translate_lang("VR Technology: Architecture, Tools, Team, and Costs")  }}
                    </div>
                    <img class="w-72 h-48"
                    ...
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base mb-5">
                            {{ @translate_lang("Obtain a clean-coded and high-performing ecommerce solution.")  }}
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base mb-5">
                            {{ @translate_lang("Secure the best ROI for implemented technology solutions.")  }}
                        </p>
                    </div>
                </div>
                ...
                <div
                    class="w-1/3 rounded overflow-hidden shadow-lg my-2  hover:shadow-2xl transition duration-500 mt-10 cursor-pointer">
                    <div class="p-5 text-center font-bold text-xl mb-2">{{ @translate_lang("A Comprehensive Guide to Real-Time Big Data
                    Analytics")  }}</div>
                    <img class="w-72 h-48"
                    ...
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base">
                            {{ @translate_lang("Communicate your brand’s unique personality through website design.")  }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="my-10 flex flex-col-reverse lg:flex-row justify-between items-center px-5 py-12 bg-gray-100">
                <div class="w-full lg:w-3/5 mt-10 lg:mt-0">
                    <h1 class="text-3xl font-semibold">{{ @translate_lang("DIGITAL MARKETING AUTOMATION")  }}</h1>
                    <p class="text-xl text-gray-700 my-6">{{ @translate_lang("We help to implement proper marketing automation tools and
                    ...
                    <ul style="list-style: square;" class="flex flex-row flex-wrap px-5 mb-5">
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("Email marketing.")  }}</li>
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("Landing page design.")  }}</li>
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("Social media marketing.")  }}</li>
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("Event management.")  }}</li>
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("Content marketing.")  }}</li>
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("Automated journey builder.")  }}</li>
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("SEO marketing.")  }}</li>
                        <li class="text-xl text-gray-700 mr-10 mb-6 w-48">{{ @translate_lang("Marketing analytics.")  }}</li>
                    </ul>
                    <a href="#" class="flex flex-row items-center text-blue-700">
                        <p class="uppercase mr-3 font-semibold">{{ @translate_lang("TALK TO THE TEAM")  }}</p>
            ...
            <div class="my-10 bg-blue-900 lg:px-16 px-3 py-10 text-white">
                <h1 class="text-2xl lg:text-3xl font-semibold">
                    <p class="mb-4">{{ @translate_lang("EXPLORE DIVERSE IMPLEMENTATION MODELS")  }}</p>
                    <hr class="w-10 h-1 bg-pink-600">
                </h1>
                <p class="text-xs lg:text-xl my-4 lg:my-8">{{ @translate_lang("We IT-enable all kinds of B2B, B2C interactions and internal
                operations.")  }}</p>
                <ul class="text-black flex flex-wrap flex-row justify-between">
                    <li
                        ...
                        <a href="#">
                            {{ @translate_lang("Online Marketplace")  }}
                        </a>
                    ...
                    <li
                        class="bg-white xl:w-80 lg:w-60 md:w-48 w-2/5  h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative hover:bg-blue-700 hover:text-white">
                        <a href="#">
                            {{ @translate_lang("Ecommerce Multistore")  }}
                        </a>
                        <div class="absolute bottom-3 right-3">
                            <i class="fa fa-arrow-right fa-rotate-45"></i>
                        </div>
                    ...
                    <li
                        class="bg-white xl:w-80 lg:w-60 md:w-48 w-2/5  h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative hover:bg-blue-700 hover:text-white">
                        <a href="#">
                            {{ @translate_lang("Headless Commerce")  }}
                        </a>
                        <div class="absolute bottom-3 right-3">
                            <i class="fa fa-arrow-right fa-rotate-45"></i>
                        </div>
            ...
            <div class='my-10 flex flex-row flex-wrap justify-evenly'>
                <div
                    class="w-1/3 rounded overflow-hidden shadow-lg my-2   hover:shadow-2xl transition duration-500 mt-10  cursor-pointer">
                    <div class="p-5 text-center font-bold text-xl mb-2">{{ @translate_lang("How To Start A Successful Online Business")  }}</div>
                    <img class="w-72 h-48"
                        src="https://www.scnsoft.com/---home-page-illustrations/ecommerce-microsite/how-to-start-a-successful-online-business.svg"
                        alt="Sunset in the mountains">
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base mb-5">
                            {{ @translate_lang("Business & tech tips for a successful online launch: business models, competitive advantages and
                ...
                <div
                    class=" w-1/3 rounded overflow-hidden shadow-lg my-2  hover:shadow-2xl transition duration-500 mt-10 cursor-pointer">
                    <div class="p-5 text-center font-bold text-xl mb-2">{{ @translate_lang("How to Sell Grocery Online")  }}</div>
                    <img class="w-72 h-48"
                        src="https://www.scnsoft.com/---home-page-illustrations/ecommerce-microsite/how-to-sell-grocery-online.svg">
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base mb-5">
                            {{ @translate_lang("Guidelines on how to find a place in the online grocery market: viable business models,
                ...
                <div
                    class="w-1/3 rounded overflow-hidden shadow-lg my-2  hover:shadow-2xl transition duration-500 mt-10 cursor-pointer">
                    <div class="p-5 text-center font-bold text-xl mb-2">{{ @translate_lang("How to Choose an Ecommerce Platform")  }}</div>
                    <img class="w-72 h-48"
                        src="https://www.scnsoft.com/---home-page-illustrations/ecommerce-microsite/how-to-choose-an-ecommerce-platform.svg"
                        alt="Sunset in the mountains">
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base">
                            {{ @translate_lang("Functional portfolio of ecommerce platforms and top 10 shortlisted by ScienceSoft.")  }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <h1 class="px-16 text-3xl py-12">
            <p class="mb-4">{{ @translate_lang("NEED TO TALK TO ECOMMERCE EXPERTS?")  }}</p>
            <hr class="w-10 h-1 bg-pink-600">
        </h1>

        <form class="px-16 py-12 bg-gray-200 text-gray-800">
            <label class="">
                {{ @translate_lang("ScienceSoft is a full-service ecommerce team to handle diverse consulting and development tasks. Outline
            ...
            <div class="flex flex-col lg:flex-row justify-between">
                <div class="flex flex-col mr-3">
                    <div class="flex justify-between flex-row flex-wrap">
                        <input type="text" name="FullName" placeholder="{{ @translate_lang("Full Name")  }}"
                            class="border-2 border-gray-500 outline-none my-3 mr-3 p-4 w-full sm:w-auto md:w-2/5 xl:w-auto" />
                        <input type="text" name="Company" placeholder="{{ @translate_lang("Company")  }}"
                            class="border-2 border-gray-500 outline-none  py-4 px-3 my-3 mr-3 w-full sm:w-auto md:w-2/5 xl:w-auto" />
                        <input type="email" name="Email" placeholder="{{ @translate_lang("Work Email")  }}"
                            class="border-2 border-gray-500 outline-none  py-4 px-3 my-3 mr-3 w-full sm:w-auto md:w-2/5 xl:w-auto">
                        <input type="text" name="Phone Number" placeholder="{{ @translate_lang("Work Phone")  }}"
                            class="border-2 border-gray-500 outline-none my-3 mr-3 py-4 px-3 w-full sm:w-auto md:w-2/5 xl:w-auto">
                    </div>
                    <textarea placeholder="{{ @translate_lang("How can we we help you?")  }}" cols="3" rows="6"
                        class="border-2 border-gray-500 outline-none my-3 -mr-3 py-4 px-3"
                        style="margin-right: 0.75rem;"></textarea>
                    <div class="flex justify-center items-center mb-3">
                        <button type="submit"
                            class="text-center uppercase bg-blue-700 hover:bg-blue-900 text-white w-56 h-16 ">{{ @translate_lang("Discuss my
                            Ecommerce needs")  }}</button>
                    </div>
                </div>
                <div class="flex lg:flex-col md:flex-row md:justify-between flex-col">
                    <div class="flex flex-col ">
                        <p class="text-xl font-semibold">{{ @translate_lang("Our contact details")  }}</p>
                    ...
                    <div class="flex flex-col my-3">
                        <p class="text-xl font-semibold mb-3">{{ @translate_lang("Press inquires")  }}</p>
                        <a href="#" class="flex items-center text-blue-500">
                            <p class="mr-3">{{ @translate_lang("GET IN TOUCH WITH US")  }}</p>
                            <i class="fa fa-arrow-right"></i>
                        </a>
                    </div>
                    <div class="flex flex-col">
                        <p class="text-xl border-2 font-semibold mb-3">{{ @translate_lang("Join our team")  }}</p>
                        <a href="#" class="flex items-center text-blue-500">
                            <p class="mr-3">{{ @translate_lang("CHECK OUR OPEN VACANCIES")  }}</p>
                            <i class="fa fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
