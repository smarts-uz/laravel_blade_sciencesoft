...
@section('main')
    ...
    <div class="mx-6 md:mx-16 lg:mx-24 my-10">
        <div class="text-2xl md:text-4xl font-bold mt-6">
            {{ @translate_lang("Data Analytics Services")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
            <img src="https://www.scnsoft.com/cover-pictures/data-analytics.svg">
            <div>
                <p class="font-normal text-lg leading-loose mt-10">
                    {{ @translate_lang("Data analytics helps businesses convert their raw business data into actionable insights. Since 1989,
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>{{ @translate_lang("Tired of Time-Consuming Instinct-Based Decisions?")  }}
                    </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
                <p class='text-gray-600 text-xl'>{{ @translate_lang("Within a reasonable time, ScienceSoft will help you defeat fragmented and
        ...
        <div class="text-2xl md:text-4xl font-bold mt-6">
            {{ @translate_lang("WHAT YOU GET WITH DATA ANALYTICS SERVICES")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
            <p class="my-8 text-xl font-normal">
                {{ @translate_lang("We are ready to implement our best data analytics practices to empower companies with informed
            ...
            <p class="my-8 text-xl font-normal">
                {{ @translate_lang("For you to ensure full-fledged data analytics, ScienceSoft covers the following technical components:")  }}
            </p>
            <div class="w-4/5">
        ...
        <div class="text-2xl md:text-4xl font-bold my-20">
            {{ @translate_lang("WHY CHOOSE SCIENCESOFT AS YOUR DATA ANALYTICS SERVICE PROVIDER")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        ...
        <div>
            <ul class="list-disc text-base md:text-lg leading-loose">
                <li class="my-8">
                    31 {{ @translate_lang("years in data analytics and data science.")  }}
                </li>
                <li class="my-8">
                    {{ @translate_lang("15 years of experience in rendering data warehouse services, designing and implementing business
                    intelligence solutions.")  }}
                </li>
                <li class="my-8">
                    {{ @translate_lang("Traditional BI and big data projects with the use of Microsoft Power BI since 2016.")  }}
                </li>
                <li class="my-8">
                    7 {{ @translate_lang("years of big data consulting and implementation practice.")  }}
                </li>
                <li class="my-8">
                    {{ @translate_lang("A multifunctional team of data analytics experts who can deliver agile solutions of different complexity
                    levels.")  }}
                </li>
            </ul>
        </div>
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ @translate_lang("WHY OUR CUSTOMERS THINK THAT DATA ANALYTICS IS WORTH INVESTING IN")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        <p class="text-xl">
            {{ @translate_lang("Customized analytical solutions we design and implement allow our customers to achieve up to:")  }}
        </p>
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>{{ @translate_lang("Wonder Whether Your Data Analytics Investments Will Pay Off?")  }}
                    </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
                <p class='text-gray-600 text-xl'>{{ @translate_lang("ScienceSoft is ready to calculate your ROI so that you eliminate the
                guesswork in figuring out the value of your data analytics project.")  }}
                </p>
            </div>
            <div class='w-2/5 m-0 flex justify-center items-center'>
                <a href="#" class='px-4 py-3  text-center bg-blue-800 text-white uppercase hover:bg-blue-900'>{{ @translate_lang("Get my data
                analytics ROI")  }}</a>
            </div>
        </div>
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ @translate_lang("OUR HALLMARK DATA ANALYTICS PROJECTS")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        ...
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ @translate_lang("CHOOSE YOUR DATA ANALYTICS SERVICE OPTION")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        <div class="flex flex-row justify-center ">
            ...
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/5 h-auto mr-10">
                <hr class="w-full border-t-4 border-blue-800" />
                <div class="p-4">
                    <p class="text-lg text-blue-700 mb-3 text-center font-bold">{{ @translate_lang("Co-sourcing with other vendors")  }}</p>
                    <p class="mb-3">{{ @translate_lang("Drawing on your needs, we can suggest either an offshore dedicated team or team
                    augmentation model of cooperation to back up your .NET development project or migration of
                    legacy software to .NET. We offer pre-vetted developers, which match your requirements –
                    you’re free to screen them before the start of cooperation.")  }}</p>

                    <button class="bg-blue-700 text-white w-full mt-3 uppercase p-2">{{ @translate_lang("Outsource 30%-40% of
                    it")  }}</button>
                </div>
            </div>
        </div>
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ @translate_lang("SUCCESS STORIES ON DATA ANALYTICS")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        <div class="rounded-sm bg-gray-50 relative transition-shadow p-2 md:p-8">
            <div class="flex flex-col md:flex-row items-start ">
                ...
                <div class=" flex flex-col w-4/5 mb-10">
                    <h1 class="text-3xl md:text-4xl font-bold">{{ @translate_lang("Big Data Implementation for Advertising Channel Analysis in
                    10+ Countries")  }}</h1>
                    <hr class="w-12 border-yellow-600 text-gray-800 my-4">
                    <p class=" text-gray-500 text-xl md:text-2xl">
                        {{ @translate_lang("Migration to a new analytical system that ScienceSoft implemented helped one of the top market
        ...
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ @translate_lang("NOT READY TO GIVE AWAY THESE DATA ANALYTICS BENEFITS?")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        <div>
            <ul class="list-disc text-base md:text-lg leading-loose">
                <li class="my-8">
                    {{ @translate_lang("Elimination of the guesswork out of your business processes.")  }}

                </li>
                <li class="my-8">
                    {{ @translate_lang("Faster and accurate reporting, analysis and planning.")  }}
                </li>
                <li class="my-8">
                    {{ @translate_lang("Identification of profit opportunities.")  }}
                </li>
                <li class="my-8">
                    {{ @translate_lang("Enhanced customer experience.")  }}
                </li>
            </ul>
        </div>
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
