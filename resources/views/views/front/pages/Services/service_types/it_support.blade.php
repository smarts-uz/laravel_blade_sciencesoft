...
<div class="mx-6 md:mx-16 lg:mx-24 my-10">
        ...
        <div class="text-2xl md:text-4xl font-bold mt-6">
            ...
            <div>
                <p class="font-normal text-lg leading-loose mt-10">
                    {{ @translate_lang("IT support comprises procedures intended to maintain failsafe IT workflows and reduce IT costs.
        ...
        <div class="text-2xl md:text-3xl font-bold uppercase">
            {{ @translate_lang("What You Get with IT Support Services")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
            ...
            <div class="flex flex-col md:flex-row  items-start">
                <div class="flex flex-row justify-start items-center w-4/5 text-xl mr-0 md:mr-8 mb-8 md:mb-0">
                    ...
                    <p class=" text-xl md:text-2xl ">
                        31 {{ @translate_lang("years of experience in information technology.")  }}
                    </p>
                </div>
            </div>
            <div class="flex flex-row justify-start items-center w-4/5 text-xl mr-0 md:mr-8 mb-8 md:mb-0">
                ...
                <p class=" text-xl md:text-2xl ">
                    {{ @translate_lang("13-year experience in help desk and application support.")  }}
                </p>
            </div>
            <div class="flex flex-row justify-start items-center w-4/5 text-xl mr-0 md:mr-8 mb-8 md:mb-0">
                <img class="m-8 w-full h-full md:w-14 md:h-14"
                    src="https://www.scnsoft.com/software-development-services/software-consulting/star.svg" alt="">
                <p class=" text-xl md:text-2xl ">
                    12 {{ @translate_lang("years of experience in ITIL-compliant IT service management.")  }}
                </p>
            </div>
            <div class="flex flex-row justify-start items-center w-4/5 text-xl mr-0 md:mr-8 mb-8 md:mb-0">
                <img class="m-8 w-full h-full md:w-14 md:h-14"
                    src="https://www.scnsoft.com/software-development-services/software-consulting/star.svg" alt="">
                <p class=" text-xl md:text-2xl ">
                    {{ @translate_lang("Microsoft Gold Partner, AWS Select Consulting Partner, IBM Business Partner.")  }}
                </p>
            </div>
            <div class="flex flex-row justify-start items-center w-4/5 text-xl mr-0 md:mr-8 mb-8 md:mb-0">
                <img class="m-8 w-full h-full md:w-14 md:h-14"
                    src="https://www.scnsoft.com/software-development-services/software-consulting/star.svg" alt="">
                <p class=" text-xl md:text-2xl ">
                    700 + {{ @translate_lang("employees on board.")  }}
                </p>
            </div>
        </div>
        ...
        <div class="text-2xl md:text-3xl font-bold uppercase">
            {{ @translate_lang("Competitive Traits of ScienceSoft’s IT Support Services")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        ...
        <div class="flex flex-row">
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/4 h-auto mr-10">
                <hr class="w-full " />
                <div class="p-4">
                    <p class="text-lg mb-3 text-center font-bold">{{ @translate_lang("Full-service IT outsourcing")  }}</p>
                    <p class="mb-3">{{ @translate_lang("Drawing on your needs, we can suggest either an offshore dedicated team or team
                     augmentation model of cooperation to back up your .NET development project or migration of
                     legacy software to .NET. We offer pre-vetted developers, which match your requirements –
                     you’re free to screen them before the start of cooperation.")  }}</p>
            ...
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/4 h-auto mr-10">
                <hr class="w-full " />
                <div class="p-4">
                    <p class="text-lg mb-3 text-center font-bold">{{ @translate_lang("Co-sourcing with an in-house IT team")  }}
                    </p>
                    <p class="mb-3">{{ @translate_lang("Outsource your entire IT landscape, including IT service planning and
                    management, to achieve greater business performance with IT ROI boosted by 50-300%.")  }}</p>
                    <p>
            ...
            <div class="rounded border-2 transition-shadow  hover:shadow-lg w-1/4 h-auto mr-10">
                <hr class="w-full  " />
                <div class="p-4">
                    <p class="text-lg mb-3 text-center font-bold">{{ @translate_lang("Co-sourcing with other vendors")  }}</p>
                    <p class="mb-3">{{ @translate_lang("Drawing on your needs, we can suggest either an offshore dedicated team or team
                    augmentation model of cooperation to back up your .NET development project or migration of
                    legacy software to .NET. We offer pre-vetted developers, which match your requirements –
                    you’re free to screen them before the start of cooperation.")  }}</p>
        ...
        <div class="flex flex-row">
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-2/5 h-auto mr-10">
                <hr class="w-full border-t-4 border-blue-800" />
                <div class="p-4">
                    <p class="text-lg text-blue-700 mb-3 text-center font-bold">{{ @translate_lang("IT Help Desk")  }}</p>
                    <p class="mb-3 italic">{{ @translate_lang("White-label cooperation is possible.")  }}</p>
                    <p>{{ @translate_lang("L1, L2, L3 support for enterprises, software companies and MSPs.")  }}</p>
                    <ul class="list-disc text-base md:text-lg leading-loose">
                        <li class="my-8">
                            {{ @translate_lang("Introduction of efficient SOPs and ITSM processes.")  }}
                        </li>
                        <li class="my-8">
                            {{ @translate_lang("Resolution of reported incidents.")  }}
                        </li>
                        <li class="my-8">
                            {{ @translate_lang("User satisfaction rate management.")  }}
                        </li>
                        <li class="my-8">
                            {{ @translate_lang("Knowledge base maintenance.")  }}
                        </li>
                        <li class="my-8">
                            {{ @translate_lang("Regular reporting.")  }}
                        </li>
                    </ul>
        ...
        <div class="text-2xl md:text-3xl font-bold my-10">
            {{ @translate_lang("Why ScienceSoft’s IT Support Matters")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        ...
        <div class="my-20  mx-auto w-full font-bold">
            <div class="w-full  sm:flex sm:flex-row justify-start flex flex-col ">
                <div
                    ...
                    <p class="font-light text-gray-400 pl-2 mx-auto">{{ @translate_lang("user satisfaction")  }}</p>
                </div>
                <div
                    class="sm:w-1/4 sm:border-l sm:border-gray-300 w-full flex flex-col justify-center hover:border-b hover:border-gray-300">
                    <p class="text-4xl text-blue-800  pl-2 mx-auto">
                    ...
                    <p class="font-light text-gray-400 pl-2 mx-auto">{{ @translate_lang("app issues")  }}</p>
                </div>
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>{{ @translate_lang("Get Your Stable and Efficient IT with Least Effort!")  }} </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
                <p class='text-gray-600 text-xl'>{{ @translate_lang("ScienceSoft professionals will conduct close monitoring of your IT
                infrastructure or its components and set up efficient IT support workflows.")  }} </p>
            </div>
            <div class='w-2/5 m-0 flex justify-center items-center'>
                <a href="#" class='px-4 py-3  text-center bg-blue-800 text-white uppercase hover:bg-blue-900'>{{ @translate_lang("launch
