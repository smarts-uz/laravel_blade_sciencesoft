...
@section('main')
        ...
        <div class="mx-24 md:mx-16 mx-6 my-10">
          ...
          <h1 class="uppercase font-bold mt-10 text-2xl">
            {{ @translate_lang("Web Design Services")  }}
          </h1>
          <hr class="w-12 mt-5 text-yellow-400 h-4" />
          <img
            src="https://www.scnsoft.com/application-development/web-design/cover-pic---web-design-(3).png"
          />
          <p class="my-5 text-lg">
            {{ @translate_lang("Founded in 1989, ScienceSoft is a provider of IT consulting and
          ...
          <p class="my-5 text-lg">
            {{ @translate_lang("With over 31 years in Information Technology, we have built up
          ...
          <p class="my-5 text-lg">
            {{ @translate_lang("We headquarter in McKinney, TX, US, have a European office in
        ...
        >
          <div class="flex flex-col">
            ...
            <div class="flex flex-wrap">
              ...
              >
                {{ @translate_lang("get my web design")  }}
              </a>
            </div>
          </div>
        </div>
        <div
          class="w-full lg:px-4 lg:flex lg:flex-row lg:justify-around flex md:items-start justify-center flex-col"
        >
          <div class="lg:w-full w-full mb-8">
            ...
            <div class="w-full px-4 flex flex-row mb-5">
              ...
              <p class="px-4 text-base sm:text-lg text-sm">
                8 {{ @translate_lang("years in digital design.")  }}
              </p>
            </div>
            <!-- ========================= -->
            <div class="w-full px-4 flex flex-row mb-5">
              <span class="w-5 h-2 bg-blue-500 mt-3"></span>
              <p class="px-4 text-base sm:text-lg text-sm">
                {{ @translate_lang("UI and UX design teams with years of practical experience.")  }}
              </p>
            </div>
            <!-- ========================= -->
            <div class="w-full px-4 flex flex-row mb-5">
              <span class="w-5 h-2 bg-blue-500 mt-3"></span>
              <p class="px-4 text-base sm:text-lg text-sm">
                {{ @translate_lang("Responsive and performance-driven design.")  }}
              </p>
            </div>
            <!-- ========================= -->
            <div class="w-full px-4 flex flex-row mb-5">
              <span class="w-5 h-2 bg-blue-500 mt-3"></span>
              <p class="px-4 text-base sm:text-lg text-sm">
                {{ @translate_lang("Focus on conversions.")  }}
              </p>
            </div>
            <div class="w-full px-4 flex flex-row mb-5">
              <span class="w-5 h-2 bg-blue-500 mt-3"></span>
              <p class="px-4 text-base sm:text-lg text-sm">
                {{ @translate_lang("Adherence to SEO and, if requested, WCAG2 regulations.")  }}
              </p>
            </div>
            <div class="w-full px-4 flex flex-row mb-5">
              <span class="w-5 h-2 bg-blue-500 mt-3"></span>
              <p class="px-4 text-base sm:text-lg text-sm">
                {{ @translate_lang("Well-established agile processes.")  }}
              </p>
            </div>
          </div>
        </div>
        <h1 class="uppercase font-bold mt-10 text-2xl">
          {{ @translate_lang("PERKS OF WEB DESIGN WITH SCIENCESOFT")  }}
        </h1>
        <div
        ...
        >
          <div
            class="lg:w-1/4 flex items-start justify-center pt-10 w-40 mx-auto"
          >
            <img
              class="w-1/3"
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            <h1 class="uppercase lg:text-3xl px-4 font-bold mt-10 text-2xl">
              {{ @translate_lang("Competitive design")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600 m-4" />
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              {{ @translate_lang("We combine your brand style and the latest web design trends,
        ...
        >
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            <h1 class="uppercase lg:text-3xl px-4 font-bold mt-10 text-2xl">
              {{ @translate_lang("Focus on your business objectives")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600 m-4" />
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              {{ @translate_lang("When working on a design of a website or web portal, our team
        ...
        >
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            <h1 class="uppercase lg:text-3xl px-4 font-bold mt-10 text-2xl">
              {{ @translate_lang("Tailored to your target audience")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600 m-4" />
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              {{ @translate_lang("We perform in-depth analysis of your users' expectations at the
        ...
        >
          <div
            class="lg:w-3/5 flex items-start justify-center pt-10 w-40 mx-auto"
          >
            <img
              class="w-full"
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            <h1 class="uppercase lg:text-3xl px-4 font-bold mt-10 text-2xl">
              {{ @translate_lang("Success Story")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600 m-4" />
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              {{ @translate_lang("ScienceSoft’s web design services resulted in a 6x increase in
              conversions of a US telecom company’s website.")  }}
            </p>
          </div>
        </div>
        <h1 class="uppercase font-bold mt-10 text-2xl">{{ @translate_lang("Web Design Services")  }}</h1>
        <hr class="w-14 mt-3 bg-yellow-500 h-1" />
        <p class="text-gray-600 font-normal text-lg leading-9">
          {{ @translate_lang("While providing the option of one-off web design, we also suggest
