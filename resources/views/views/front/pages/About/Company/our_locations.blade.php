...
<div class="mx-6 md:mx-16 lg:mx-24 my-10">
    ...
    <div class="text-3xl md:text-5xl font-bold">
        {{ @translate_lang("Thinking Globally, Acting Locally")  }}
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
    </div>
    <div class="text-xl font-normal leading-relaxed text-left">
        {{ @translate_lang("ScienceSoft is headquartered in ")  }}<strong>{{ @translate_lang("McKinney, Texas.")  }}</strong>{{ @translate_lang(" Our current network includes offices and
        delivery centers
    ...
    <div class="text-xl font-normal mt-8">
        {{ @translate_lang("Regardless of the location, our customers have access to our best technical skills and industry knowledge.")  }}
    </div>

    <div class="text-3xl font-medium mt-24">
        {{ @translate_lang("OFFICES AND DELIVERY CENTERS")  }}
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
    </div>
    <div class="flex justify-between flex-wrap ">
        <div class="flex-col w-full lg:w-1/4 md:w-1/2 my-10">
            <div class="flex justifiy-start items-end">
                ...
                <div class="ml-2 text-xl font-medium">
                    {{ @translate_lang("United States - Headquarters")  }}
                </div>
            </div>
            <div class="pr-20 leading-relaxed mt-6 mb-4">
                {{ @translate_lang("5900 S. Lake Forest Drive Suite 300, McKinney, Dallas area, TX 75070")  }}
            </div>
            <div class="mb-4">
        ...
        <div class="flex-col w-full lg:w-1/4 md:w-1/2 my-10">
            <div class="flex justify-start  items-end">
                ...
                <div class="ml-2 text-xl font-medium">
                    {{ @translate_lang("Gulf Cooperation Council")  }}
                </div>
            </div>
            <div class="pr-20 leading-relaxed mt-6 mb-4">
                {{ @translate_lang("Fujairah - Creative Tower, POB 4422 Fujairah, United Arab Emirates")  }}
            </div>
            <div class="mb-4">
        ...
        <div class="flex-col w-full lg:w-1/4 md:w-1/2 my-10">
            <div class="flex justify-start  items-end">
                ...
                <div class="ml-2 text-xl font-medium">
                    {{ @translate_lang("European office")  }}
                </div>
            </div>
            <div class="leading-relaxed mt-6 mb-4">
                {{ @translate_lang("2 Myyrmäenraitti, Vantaa, ZIP 01600, Finland")  }}
            </div>
            <div class="mb-4">
