        ...
        <div class="sm:mt-0 sm:w-full sm:px-8 flex-col md:flex-row flex-wrap justify-between">
          ...
          <div class="flex justify-between flex-wrap w-full mt-5">
            <div class="flex flex-row flex-wrap">
              <span class="text-base underline w-full md:w-48 text-white text-opacity-70 mr-5 hover:text-white">
              {{ @translate_lang("About ScienceSoft")  }}</span>
              <span class="w-full md:w-48">
              <a href="#" class="text-base text-white  underline mr-5 text-opacity-70 text-md hover:text-white">
              {{ @translate_lang("Join Us as an agent")  }}</a></span>
              <span class="w-full md:w-48">
              <a href="#" class="text-base  text-white  underline mr-5 text-opacity-70 text-md hover:text-white">
              {{ @translate_lang("Privacy Policy")  }}</a></span>
              <span class="w-full md:w-48">
              <a href="#" class="text-base text-white  underline mr-5 text-opacity-70 text-md hover:text-white">
              {{ @translate_lang("Terms of Use")  }}</a></span>
            </div>
            <div>
              <span class="my-2 text-base text-white text-opacity-70 text-md">{{ @translate_lang("For press inquries:")  }}
              <a href="mailto: contact@scnsoft.com" class="text-white underline text-opacity-70 text-md hover:text-white">
