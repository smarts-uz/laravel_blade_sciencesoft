...
@section('main')
    ...
    <main class="overflow-hidden">
        ...
        <div class="pt-8">
            <div
                class="grid container lg:grid-cols-5 md:grid-cols-5 sm:grid-cols-2 m-auto pt-16 items-center justify-center mb-10">
                <div data-aos="fade-left">
                    <img src="https://oe.uz/local/templates/oe/media/images/brand/icons-feature/1.svg" alt=""
                        class="m-auto">
        ...
        <div class="container max-w-5xl mx-auto relative  my-0 mx-auto relative">
          ...
          animation: moveline 4s linear forwards;" class="path invisible visible"
                        ...
                        opacity="0.5" stroke-width="9" stroke="#7cccdb" fill="none" />
                </svg>
                ...
                <div class="grid grid-cols-1 justify-center">
                    <div class="grid justify-center">
                        <div class="grid  grid-cols-1 md:grid-cols-2 gap-5">
                            <div class=" p-5">
                                <img class="" src="https://oe.uz/local/templates/oe/media/images/brand/icons-why/1.svg"
                                    alt="">
        ...
        <div class="bg-gray-50 z-0" data-aos="fade-up-right">
            <div style=" font-size: 17px" class="pt-20 text-gray-700 pb-20">
                ...
                <div style="margin-left: 20%; margin-right: 20%;" class="z-0 text-gray-600 text-lg">
                    <p>
                        Сейчас <b>разработка логотипа в Узбекистане</b> является неотъемлемой частью шагов по созданию
                        бренда. <b>Заказать
                            логотип в Ташкенте и айдентику</b> для своего бренда вы можете <b>в брендинговом агентстве в
                            Tашкенте.</b> Наши
                        дизайнеры с многолетним опытом работы, которые занимаются <b>разработкой логотипов в</b> Ташкенте,
                        изучат ваш
                        бренд и предложат неповторимые идеи для <b>разработки логотипа.</b> Также вы можете <b>заказать
                            брендбук</b> для
                        вашего бизнеса.
                        <br><br>
                        ...
                        дизайнеры сделают детальный анализ в основе ярких идей. Начиная работу над проектом, мы анализируем
                        ваш
                        бизнес, целевую аудитории и состояние рынка. Так мы устанавливаем прочную связь между компанией и
                        его
                ...
                <div class="flex justify-end">
                    <div class="flex">
                        <div class="flex justify-center items-center my-20 relative px-20 pt-10 leading-10">
                            <h1 data-aos="fade-up" class="text-5xl font-bold text-blue-700 z-10 opacity-50">Другие <br>
                                услуги
                            </h1>
