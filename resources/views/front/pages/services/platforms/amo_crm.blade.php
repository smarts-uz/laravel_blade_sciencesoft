...
@section('main')
    ...
    <main class="overflow-hidden">
        ...
        <div class="bg-black h-auto px-4 pt-32">
            <div
                ...
                <div data-aos="fade-left"
                    class="my-8 flex justify-center border-8 border-blue-600 rounded-tr-3xl rounded-bl-3xl">
        ...
        <div>
            ...
            <div class="grid sm:grid-cols-5 grid-cols-2  m-auto justify-between pt-16 max-w-7xl">
                <div class="pt-8" data-aos="fade-left">
                    <img src="https://oe.uz/local/templates/oe/media/images/amo-crm/icons-feature/1.svg" alt=""
                        class="m-auto" />
                ...
                <div>
                    <div class="flex justify-center mx-6 mt-10">
                        <div class="text-5xl  leading-10 ">
                            <div>
                                <div class="flex">
                                    <p style="font-size: 10rem" class="font-bold text-gray-500 mt-10" data-aos="fade-up">1
                                    </p>
                                ...
                                <div>
                                    <p class="text-gray-700 text-lg leading-6 mt-10 ml-24 ">
                                        ...
                                        Наши маркетинговая агенство поможет вам в разработке и внедрение СРМ систем в
                                        Ташкенте
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="grid justify-center">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-10 ">
                            ...
                            <div class="mb-10 border-1 bg-white rounded-lg shadow-lg mx-2 p-5 " data-aos="flip-left">
                                <img src="https://oe.uz/local/templates/oe/media/images/brand/icons-what/6.svg" alt=""
                                    class="mx-auto">
                                <p class="text-center text-sm p-3 text-gray-600">Команда квалифицированных профессионалов
                                </p>
                            </div>
            ...
            <div class="flex justify-center items-center mt-20 mb-10 relative ">
                <h1 class="text-4xl font-bold text-white z-10 text-blue-600 text-center" data-aos="fade-left">Бизнес без CRM
                </h1>
            ...
            <div class="flex justify-center items-center mt-20 mb-10 relative ">
                <h1 class="text-4xl font-bold text-white z-10 text-blue-600 text-center" data-aos="fade-right">Возможности
                    СРМ системы</h1>
                <div class="flex text-center absolute item-center justify-center z-0">
                    <p data-aos="fade-up" style="font-size: 8rem" class="  font-bold  text-gray-300 ">
                        3
                ...
                <div class="max-w-7xl flex flex-col justify-center px-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 justify-center container mx-auto m-20">
                        ...
                        <div data-aos="fade-left" class="pt-8">
                            ...
                            <ul class="list-disc text-blue-700 leading-9">
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg">Настраивайте воронку продаж
                                        самостоятельно под свои нужны.</span>
                                </li>
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg">Добавляйте, называйте,
                                        меняйте местами этапы своей воронки.</span>
                                </li>
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg">Настраивайте автоматический
                                        переход от этапа к этапу.</span>
                                </li>
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg">Помечайте разными цветами
                                        каждый этап.</span>
                                </li>
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg">Добавляйте примечания в
                                        карточке клиента, любую информацию в качестве заметки.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 justify-center md:grid-cols-2 container mx-auto m-20 ">
                        <div data-aos="fade-right" class="pt-8">
                            ...
                            <ul class="list-disc text-blue-700 leading-9">
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg"> AmoCRM помогает следить за
                                        тем, чтобы по каждой сделке было запланировано действие. Если задачи не
                                        поставлены — система сигнализирует об этом.</span>
                                </li>
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg">Вы можете создавать задачи
                                        для напоминания менеджерам о необходимости совершения того или иного действия со
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 justify-center container mx-auto m-20">
                        ...
                        <div data-aos="fade-left" class="pt-8">
                            ...
                            <ul class="list-disc text-blue-700 leading-9">
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg"> Аналитика по воронке
                                        позволит увидеть на каких этапах вы теряете клиентов и предоставит достаточное
                                        количество данных, чтобы принять верные управленческие решения.</span>
                                </li>
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg"> Аналитика по сотрудникам
                                        покажет успехи, проблемные зоны и загруженность по каждому сотруднику.</span>
                                </li>
                                <li class="ml-6 text-3xl"><span class="text-gray-700  text-lg">Аналитика по целям позволяет
                                        поставить KPI для сотрудников, отделов и компании в целом.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 container mx-auto max-w-7xl">
                    <div class="flex justify-center items-center pt-8" data-aos="fade-right">
                        <div>
                            ...
                            <p class="text-gray-700 pr-5">amoCRM обладает уникальным и очень развитым интерфейсом
                                разработчика,
                                что
            ...
            <div class="mt-48">
                ...
                <div class="px-8">
                    <div data-aos="zoom-in" class="max-w-3xl mx-auto bg-white shadow-2xl rounded-3xl p-10 sm:p-20 -mt-56">
                        <h1 class="text-center text-xl sm:text-3xl font-semibold leading-tight text-blue-700">
            ...
            <div class="container mx-auto grid justify-center ">
                <div class="flex justify-center flex-col lg:flex-row">
                    <div class="  bg-white rounded-lg shadow-lg m-5 lg:flex-1 p-5 hover:bg-blue-700" data-aos="flip-left">
                        ...
                        <h1 class="text-gray-700 font-bold text-sm py-5  hover:text-white">ДЕМОНСТРАЦИЯ ВОЗМОЖНОСТЕЙ AMOCRM
                        </h1>

                    </div>
                    <div class="  p-3 bg-white  rounded-lg shadow-lg m-5 lg:flex-1 p-5 hover:bg-blue-700"
                        data-aos="flip-left">
                        <p class="text-2xl font-bold text-white bg-blue-700 inline px-4 py-3 rounded-full">02</p>
                        <h1 class="text-gray-700 font-bold text-sm py-5  hover:text-white">СБОР И ОПИСАНИЕ БИЗНЕС-ПРОЦЕССОВ
                        </h1>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 max-w-md justify-center">
                            <div class="p-5">
                                <img class="rounded-full border-indigo-600 border-4"
                                    src="{{ asset('images/open_engine/images/4icons/3.svg') }}" alt="" />
                                <p>01</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="flex justify-center pt-8" data-aos="fade-right">
                    <img src="https://oe.uz/local/templates/oe/media/images/amo-crm/certificat.png" alt="">
                </div>
                <div class="pt-8">
                    ...
                    <div>
                        <p class="text-center text-gray-600 text-2xl sm:px-20" data-aos="fade-up">Наша компания —
            ...
            <div class="bg-blue-700 h-40 max-w-4xl rounded-r-2xl -mb-20 z-20 relative" data-aos="fade-up-right">
                <div class="flex justify-center items-center my-20 pt-10">
                    ...
                    <div class="flex text-center absolute item-center justify-center z-0">
                        <p data-aos="fade-up" style="font-size: 8rem" class="  font-bold  text-gray-400 opacity-50">
                            9
                        </p>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 z-0" data-aos="fade-up">
                <div style="margin-left: 20%; margin-right: 20%; font-size: 17px" class="pt-20 text-gray-700 pb-20">
                    ...
                    <div class="z-0">
                        <p>
                            Желаете внедрить <b>CRM системы</b> и автоматизировать свой бизнес? Доверьте настройку CRM
                            системы
                            <b>партнерам amoCRM в Ташкенте,</b> агентству «Open Engine». Это поможет отправлять сообщения,
                            письма и
                            рекламу клиентам вашей компании. Также у вас появиться возможность отслеживания эффективности и
                            <b>интегрировать IP телефонию, астерикс под ключ</b> . Мы поможем вам повысить повторные
                            продажи.
                            <br><br>

                            Мы автоматизируем ваш бизнес! Предоставляем программу по автоматизации торговли, магазина и
                            документооборота. Работу выполняем оперативно, конфиденциально и по приемлемым ценам. Мы
                            ознакомим
                            вас с системой и научим работать с ним. Также обеспечим техническую поддержку. Автоматизации
                            торговли, Автоматизация магазина в ташкенте, Автоматизация работы склада, Автоматизация
                            складского
                            ...
                            Программа для печати этикеток, Программа для торговли, Программа для магазина, битрикс24,
                            Битрикс24
