    ...
    <main class="overflow-hidden">
        ...
        <div class="flex justify-center items-center my-20 relative">
            <h1 data-aos="fade-down"
                class="font-bold sm:text-4xl text-3xl font-bold text-blue-700 z-10 text-center leading-10">Что такое <br>
        ...
        <div class="flex justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 justify-center gap-5">
                ...
                <div class="flex flex-col justify-center md:max-w-md p-4 text-xl">
                    <p>Это официальный инструмент поисковых систем Google и Яндекс. Реклама показывается людям в контексте
                        их
        ...
        <div class="flex justify-center items-center mb-10 my-20 relative">
            <h1 data-aos="fade-down" class="sm:txet-4xl font-bold text-3xl font-bold text-blue-700 z-10">Этапы разработки
                сайта</h1>
            <div class="flex text-center absolute item-center justify-center z-0">
                <p data-aos="fade-up" style="font-size: 8rem" class="  font-bold  text-gray-300 ">
                    2
            ...
            <div class="container mx-auto flex flex-col ">
                <div class="flex justify-center flex-col md:flex-row">
                    <div style="border-left-width: 15px"
                        class="flex border-blue-700 bg-white rounded-md shadow-lg m-5 md:flex-1 p-5" data-aos="flip-left">
        ...
        <div class="flex justify-center items-center">
            ...
            <a href="" class="bg-blue-400 text-white px-3 py-3 transition duration-300 ease-in-out hover:bg-blue-300 ml-1">
                заказать проект
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-5 container m-auto justify-center text-center">
            <div class="text-center grid grid-cols-1 justify-center">
                <div class="grid justify-center">
                    <img class="block shadow-lg  rounded-full"
                        src="{{ asset('images/open_engine/seo_promotion/images/brands/google.png') }}" alt="">
                </div>
            ...
            <div class="text-center grid grid-cols-1 justify-center">
                <div class="grid justify-center">
                    <img class="shadow-lg  rounded-full"
                        src="{{ asset('images/open_engine/seo_promotion/images/brands/yandex.png') }}" alt="">
                </div>
            ...
            <div class="text-center grid grid-cols-1 justify-center">
                <div class="grid justify-center">
                    <img class="shadow-lg  rounded-full"
                        src="{{ asset('images/open_engine/seo_promotion/images/brands/mailru.png') }}" alt="">
                </div>
            ...
            <div class="text-center grid grid-cols-1 justify-center">
                <div class="grid justify-center">
                    <img class="shadow-lg  rounded-full"
                        src="{{ asset('images/open_engine/seo_promotion/images/brands/maps.png') }}" alt="">
                </div>
        ...
        <div style="z-index: 100; height: 14rem" class="bg-blue-700 max-w-5xl rounded-r-2xl z-20 relative">
            <div class="flex justify-center items-center my-20 pt-10 " data-aos="fade-right">
                ...
                <div class="flex text-center absolute item-center justify-center z-0">
                    <p data-aos="fade-up" style="font-size: 8rem" class="  font-bold  text-gray-600 ">
                        7
                    </p>
                </div>
            </div>
        ...
        <div class="max-w-xl mx-auto my-10 mb-40 relative" data-aos="fade-left">
            <img class="-my-16 m-auto shadow-lg rounded-full border-gray-300 border"
                src="{{ asset('images/open_engine/context_advertisement/images/4icons/3.svg') }}" alt="">
            ...
            <div class="shadow-lg rounded-2xl z-20 px-10 pt-10 pb-5 m-5 z-20">
                <div class=" text-center">
                    <h1 style="font-size: 21px" class="font-bold text-gray-700 mb-1 mt-5">Разработать индивидуальную
                        стратегию?</h1>
        ...
        <div class="bg-gray-50 z-0" data-aos="fade-up">
            <div style="margin-left: 20%; margin-right: 20%; font-size: 17px" class="pt-20 text-gray-700 pb-20">
                ...
                <div class="z-0">
                    <p>
                        Специалисты <b>рекламного агентства в Ташкенте </b>«Open Engine» предлагают комплекс услуг по
                        <b>рекламе в поисковых системах.</b> <b>Реклама в </b><b>Google</b> и <b>Реклама в
                        </b><b>Y</b><b>andex</b> являются платформой для комплексной рекламы вашей компании. Мы сделаем
                        точную настройку целей, <b>медийной рекламы</b> и <b>контекстной рекламы</b> в <b>поисковых
                            системах</b> для получения результата. Ваша реклама будет представлена тем пользователям,
                        которые наиболее настроены на покупку. Оставьте заявку и мы позвоним вам и предоставим полную
                        информацию.
                    </p>
                </div>
