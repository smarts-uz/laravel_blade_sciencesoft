...
>>>>>>> 4d661ca473b121839673ace280f696d3f04900a2:resources/views/front/pages/services/solutions/data_analytics.blade.php
            ...
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>
                        {{ _trans('Wonder Whether Your Data Analytics Investments Will Pay Off?') }}
                    </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
                <p class='text-gray-600 text-xl'>
        ...
        <div class="flex flex-row justify-center ">
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/5 h-auto mr-10">
                ...
                <div class="p-4">
                    <p class="text-lg text-blue-700 mb-3 text-center font-bold">
                        {{ _trans('Full-service IT outsourcing') }}</p>
                    <p class="mb-3">
                        {{ _trans("Drawing on your needs, we can suggest either an offshore dedicated team or team
            ...
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/5 h-auto mr-10">
                ...
                <div class="p-4">
                    <p class="text-lg text-blue-700 mb-3 text-center font-bold">
                        {{ _trans('Co-sourcing with an in-house IT team') }}
                    </p>
                    <p class="mb-3">
                        {{ _trans("Outsource your entire IT landscape, including IT service planning and
                    ...
                    <button
                        class="bg-blue-700 text-white w-full mt-3 uppercase p-2">{{ _trans("Outsource 70%-90% of
                    it") }}</button>
                </div>
            </div>
            ...
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/5 h-auto mr-10">
                ...
                <div class="p-4">
                    <p class="text-lg text-blue-700 mb-3 text-center font-bold">
                        {{ _trans('Co-sourcing with other vendors') }}</p>
                    <p class="mb-3">
                        {{ _trans("Drawing on your needs, we can suggest either an offshore dedicated team or team
                    augmentation model of cooperation to back up your .NET development project or migration of
                    legacy software to .NET. We offer pre-vetted developers, which match your requirements –
                    ...
                    <button
                        class="bg-blue-700 text-white w-full mt-3 uppercase p-2">{{ _trans("Outsource 30%-40% of
                    it") }}</button>
                </div>
            </div>
        </div>
