...
<div class="mx-6 md:mx-16 lg:mx-24 my-10">
      <!-- Custom Enterprise -->
        ...
        <h1 class="font-bold mt-10 text-4xl">{{ t("Hire Golang Developers | Advanced Tech Expertise")  }}</h1>
        <hr class="w-12 border-b-2 border-yellow-600  my-4"/>
        <img src="https://www.scnsoft.com/software-development-services/golang/hire-Smart Software's-golang-developers.svg" alt="">
        <p class="pt-5">
           <strong>{{ t("Go")  }}</strong>, {{ t("or")  }} <strong>{{ t("Golang")  }}</strong>, {{ t("is a cross-platform server-side language to build heavy-load
           software with exceptionally high performance and scalability due to native support of
           concurrency, fast code compilation and automatic memory management. Smart Software’s developers
        ...
        <div class='flex justify-between items-center p-10 shadow-lg mt-3'>
            ...
            <h1 class='text-gray-900 mt-6'>
                <p class='text-2xl font-bold'>{{ t("Start Building Your Software in a Couple of Weeks!")  }}</p>
                <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
            </h1>
              <p class='text-gray-600 text-xl'>{{ t("We will develop a scalable solution with neat UX design that answers your business needs.")  }}</p>
            </div>
            <div class='w-1/3 m-0 flex justify-center items-center'>
              <a href="#" class='px-8 py-3 bg-blue-700 text-white uppercase hover:bg-blue-900'>{{ t("Get a Free Consulation")  }}</a>
            </div>
        </div>

        <div class="flex flex-col">
            <h1 class="uppercase font-bold mt-10 text-2xl">
                {{ t("Smart Software’S FACTS")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600  my-4"/>
            <div class="flex flex-row">
              ...
              <div class="pt-12">
                <h1 class="font-bold text-xl">{{ t("Gold")  }}</h1>
                <div class="mt-8">
                  <div class="flex flex-row">
                    <span class="text-blue-600 mr-4">&#9632;</span>
                    <p class="text-lg">
                        {{ t("Established Lean, Agile, and DevOps culture.")  }}
                    </p>
                  </div>
                  <div class="flex flex-row">
                    <span class="text-blue-600 mr-4">&#9632;</span>
                    <p class="text-lg">
                        {{ t("Experience in advanced technologies: AI, machine learning, IoT, big data, blockchain.")  }}
                    </p>
                  </div>
                  <div class="flex flex-row">
                    <span class="text-blue-600 mr-4">&#9632;</span>
                    <p class="text-lg">
                    {{ t("HQ – McKinney, Texas. Offshore development centers in Eastern Europe, representative offices in UAE, Latvia, Finland, and Ukraine.")  }}
                    </p>
                  </div>
                  <div class="flex flex-row">
                    <span class="text-blue-600 mr-4">&#9632;</span>
                    <p class="text-lg">
                    {{ t("25 of our .NET developers have Microsoft Certified Technology Specialist (MCTS) and Microsoft Certified Professional Developer (MCPD) certifications.")  }}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <h1 class="uppercase font-bold mt-10 text-2xl">{{ t("OUR DEVELOPMENT SKILLS")  }}</h1>
        <hr class="w-12 border-b-2 border-yellow-600  my-4"/>
        <!-- no element!!! -->
        <div class=" text-center">
          <button type="submit" class=" px-3 py-2 bg-blue-700 text-white text-sm text-bold uppercase hover:bg-blue-900">{{ t("Request Go Programmers’ CV")  }}</button>
        </div>
        <h1 class="uppercase font-bold mt-10 text-2xl">{{ t("OUR DEVELOPMENT SKILLS")  }}</h1>
        <hr class="w-12 border-b-2 border-yellow-600 my-4"/>
        <div class="flex flex-wrap text-center justify-between">
            <div class="w-1/5 border">
              ...
              <p class="inner">
                <a href="#" class="hover:text-blue-700">{{ t("AI and machine learning software")  }}</a>
              </p>
            </div>
