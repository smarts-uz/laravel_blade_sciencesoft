        ...
        <div class="rounded-sm border-2 border-white shadow-2xl transition-shadow w-full mr-20 p-8">
            <div class="flex flex-col">
                ...
                <div class=" flex flex-wrap">
                    ...
                    <div class="uppercase text-white bg-blue-700 py-2 px-4 w-2/5 mt-8 lg:w-1/5 text-center">
                        {{ _trans('request a consultation') }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-center flex-wrap">
                ...
                <div class="">
                    ...
                    <div class=" mt-4">
                        <h1 class="text-2xl md:text-3xl font-semibold">
                            {{ _trans('Deep healthcare industry knowledge') }}</h1>
            ...
            <div class="rounded-sm w-full lg:w-2/5 p-10 mx-4 mt-8 border-2 transition-shadow hover:shadow-xl p-2 md:p-8">
                <div class="">
                    ...
                    <div class="mt-4">
                        <h1 class="text-2xl md:text-3xl font-semibold">
                            {{ _trans('Consulting and practical assistance') }}</h1>
