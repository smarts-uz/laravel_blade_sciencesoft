    ...
    <main>
        ...
        <div>
            <p class="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold pt-5 ">
                {{ _trans('Insurance Software: IT Solutions for Streamlined Insurance Services') }}</p>
        ...
        <div class="text-xl py-4">
            ...
            <p> {{ _trans('Having 8-year experience with theinsurance industry, ScienceSoftprovides insurance companies with ITsolutions and related services fromsolution consulting to support to helpthem') }}
                <span
                    class="font-bold">{{ _trans('facilitate digital lead generationand increase the efficiency ofapplication processing and claimmanagement.') }}</span>
            </p>
        </div>
        ...
        <div class="mx-6 md:mx-16 lg:mx-24 my-10">
            <p class="text-xl  md:text-3xl lg:text-3xl font-bold pt-5 ">
                {{ _trans('WHAT MAKES TEAMPRO A RELIABLE PARTNER') }}</p>
            <hr class="w-12 border-b-2 border-yellow-600 my-4" />
            <!-- STARS -->
            <div class="grid md:grid-cols-3 gap-4 border mb-4">
                <div>
                    ...
                    <p class="text-center text-xl"><b>31</b> {{ _trans('years in software') }} <br>
                        {{ _trans('development and consulting') }}</p>
                </div>
                <div>
                    <div class="flex justify-center pb-10">
                        <img src="{{ asset('/images/industries/insurance/star.svg') }}" alt="" class="w-10">
                ...
                <div>
                    ...
                    <p class="text-center text-xl">{{ _trans('Experience in delivering both') }} <br><b>B2B</b>
                        {{ _trans('and') }} <b>B2C</b> {{ _trans('insurance') }} <br> {{ _trans('solutions.') }}
                    </p>
                </div>
            </div>
            <!-- END-STARS -->
            <div class="grid md:grid-cols-2 gap-4 border">
                <div class="text-center pb-4">
                    <div class="flex justify-center pb-5">
                        <img class="w-28"
                            src="{{ asset('/images/industries/insurance/aws-apn-select-consulting-partner.svg') }}"
                            alt="">
                    </div>
                ...
                <div class="text-center">
                    <div class="flex justify-center pb-5">
                        <img class="w-72 border"
                            src="{{ asset('/images/industries/insurance/microsoft-gold-partner-8-competences.svg') }}"
                            alt="">
                    </div>
        ...
        <div class="mx-6 md:mx-16 lg:mx-24 my-10">
            <p class="text-xl md:text-3xl lg:text-3xl font-bold pt-5 ">
                {{ _trans('IT SOLUTIONS FOR INSURANCE WE DEVELOP') }}</p>
            <hr class="w-12 border-b-2 border-yellow-600 my-4" />
            <div class="grid md:grid-cols-2">
                <div class="shadow-xl border m-6">
                    <div class="bg-blue-300 border-t-8"></div>
                    <div class="p-4">
                        <img src="{{ asset('/images/industries/insurance/underwriting-1.svg') }}" alt="img-one"
                            class="w-28 mx-auto" />
                        ...
                        <p class="text-sm rounded bg-green-50 mb-10 p-1">
                            {{ _trans('Cloud-native solutions based on Azure and AWS services') }}</p>
                    </div>
                </div>
                <div class="lg:mx-4 shadow-xl border m-6">
                    ...
                    <div class="p-4">
                        ...
                        <p class="font-semibold mb-1">{{ _trans('Technology/platform') }}</p>
                        <p class="text-sm rounded bg-green-50 mb-10 p-1">
                            {{ _trans('Cloud-native solutions based on Azure and AWS services PWA or native mobile applications') }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:mx-4 shadow-xl border m-6">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <p class="text-sm rounded bg-green-50 mb-1 w-40">
                                {{ _trans('Dynamics 365 Customer Service') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2">
                ...
                <div class="shadow-xl border m-5">
                    ...
                    <div class="p-4">
                        ...
                        <p class="font-bold  text-xl mb-3">{{ _trans('Outsourcing of one or several IT functions:') }}
                        </p>
