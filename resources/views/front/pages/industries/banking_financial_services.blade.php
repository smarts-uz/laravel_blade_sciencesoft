    ...
    <div class="uppercase border-2 border-blue-700 text-blue-700 text-white py-3 px-10">
      ...
      <div
              ...
              <div class="lg:w-3/4  mx-auto w-11/12 mb-8">
                  ...
                  <!-- ========================= -->
                  <div class="w-full  px-4 flex flex-row mb-5">
                      <span class="w-2 h-2 bg-blue-500 mt-3"></span><p class="px-4 text-base sm:text-lg text-sm">{{ _trans("set up limits for their cards")  }}</p>
                  </div>
                  <!-- ========================= -->
                  <div class="w-full  px-4 flex flex-row mb-5">
                      <span class="w-2 h-2 bg-blue-500 mt-3"></span><p class="px-4 text-base sm:text-lg text-sm">{{ _trans("make payments")  }}</p>
                  </div>
                  <!-- ========================= -->
                  <div class="w-full  px-4 flex flex-row mb-5">
                      <span class="w-2 h-2 bg-blue-500 mt-3"></span><p class="px-4 text-base sm:text-lg text-sm">{{ _trans("transfer money between banking accounts")  }}</p>
                  </div>
                   <!-- ========================= -->
                   <div class="w-full  px-4 flex flex-row mb-5">
                    <span class="w-2 h-2 bg-blue-500 mt-3"></span><p class="px-4 text-base sm:text-lg text-sm">{{ _trans("request bank statements or other applicable documents online")  }}</p>
                </div>
                 <!-- ========================= -->
                 <div class="w-full  px-4 flex flex-row mb-5">
                  <span class="w-2 h-2 bg-blue-500 mt-3"></span><p class="px-4 text-base sm:text-lg text-sm">{{ _trans("find a branch or ATMs in a particular location, and much more.")  }}</p>
              </div>
              </div>
          </div>
          ...
          <div class="rounded-sm border-2 border-white shadow-xl transition-shadow w-full mr-20 p-8">
            <div class="flex flex-col">
              ...
              <div class="uppercase text-white bg-blue-700 flex  py-2 px-4 w-2/5 mt-8 lg:w-1/5 text-center">{{ _trans("contact us")  }}</div>
            </div>
            </div>
          </div>
