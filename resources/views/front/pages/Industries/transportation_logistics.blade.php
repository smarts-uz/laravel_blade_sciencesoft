...
<main class="flex w-full">
    ...
    <section class="w-full p-4 pr-10">
      <div>
        ...
        <img src="{{ assets ('images/industries/transportation_logistics/transportation_1.svg')}}">
  ...
  <div class="pt-12">
    ...
    <hr class="w-12 border-b-2 border-yellow-600  my-4"/>
                ...
                <div class="mt-8 flex">
                  <img class="w-1/5" src="{{ assets ('images/industries/transportation_logistics/why-ss.svg')}}" alt="">
                  <div>
              ...
              <div class="rounded-sm w-full lg:w-2/5 p-10  mt-8 border-2 transition-shadow hover:shadow-xl p-2 md:p-8">
                ...
                <div class="">
                  <div class="  text-xl mr-0 md:mr-8 mb-8 md:mb-0">
                    <img class="w-16 h-16" src="{{ assets ('images/industries/transportation_logistics/star.svg')}}" alt="">
                  </div>
                  <div class="    mt-4">
