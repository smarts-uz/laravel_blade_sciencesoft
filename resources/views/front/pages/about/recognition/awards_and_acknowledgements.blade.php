...
@section('main')
    ...
    <div>
        <div class="my-4">
            <h1 class="uppercase font-extrabold md:text-3xl text-xl pb-4">
                {{ _trans('TeamPRO’s Awards and Recognitions') }}
            </h1>
        ...
        <div class="grid md:grid-cols-3 grid-cols-1">
            <div class="flex flex-row mt-6 col-span-2 ">
                <div class="justify-start md:block hidden border-2 p-2 px-4 w-20 h-12 mx-10">
                    <p class="font-bold">
                        2020
                    </p>
                </div>
                <ul class="list-disc text-base md:text-xl leading-loose col px-2">
                    <li class="mb-4">
            ...
            <div class="hidden md:flex flex-col justify-end items-end ml-20 w-48">
                <img src="https://www.scnsoft.com/partners/clutch-top-1000-b2b-companies-2020.svg" alt="">
                <img src="https://www.scnsoft.com/partners/clutch-top-1000-b2b-companies-2020.svg" alt="">
                <img src="https://www.scnsoft.com/partners/clutch-top-1000-b2b-companies-2020.svg" alt="">
                <img src="https://www.scnsoft.com/partners/clutch-top-1000-b2b-companies-2020.svg" alt="">
                <img src="https://www.scnsoft.com/partners/clutch-top-1000-b2b-companies-2020.svg" alt="">
        ...
        <div class="mt-20">
            <h1 class="text-xl md:text-3xl font-bold ">{{ _trans('OUR AWARD-WINNING PROJECTS') }}</h1>
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
            <div>
                <div class="w-full flex md:flex-row flex-col justify0-center py-3 border border-gray-200">
                    <img
        ...
        <div class="swiper-container about-slide my-5 h-40">
