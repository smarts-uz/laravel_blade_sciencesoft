...
@section('main')
    ...
    <div class="my-10">
        ...
        <p class="py-5 text-lg text-gray-500">
            {{ _trans('This privacy statement explains what personal data ScienceSoft collects from you and how we use that data.') }}
        </p>
        ...
        <p class="py-3 text-lg text-gray-500">
            <strong>{{ _trans(' Website data.') }}</strong>{{ _trans(' We collect data about how you interact within ScienceSoft website. For example, we collect:') }}
        </p>
        <ul class="list-disc pl-5">
            <li class="py-2 text-lg text-gray-500">
        ...
        <div class="w-10 h-0.5 bg-yellow-600"></div>
        <p class="py-3 text-lg text-gray-500">
            {{ _trans('ScienceSoft collects the data for the following purposes: sending communications, including promotional communications; advertising; analyzing website visitor statistics; technical website troubleshooting; improving website user experience.') }}
        </p>
        <p class="py-3 text-lg text-gray-500">
        ...
        <ul class="list-disc pl-5">
            ...
            <li class="py-2 text-lg text-gray-500">
                {{ _trans('Protect the rights of ScienceSoft, including enforcing the terms governing the use of the services.') }}
            </li>
        </ul>
        <p class="py-3 text-lg text-gray-500">
        ...
        <p class="py-3 text-lg text-gray-500">
            {{ _trans('Please, note that some of our website pages include links to products of third parties whose privacy practices may differ from those of ScienceSoft. If you provide personal data to any of those parties, your data is governed by their privacy statements.') }}
        </p>
        ...
        <div class="w-10 h-0.5 bg-yellow-600"></div>
        <p class="py-3 text-lg text-gray-500">
            {{ _trans('ScienceSoft uses cookies (small text files placed on your device) and similar technologies to provide our online services and to help collect data. The text in a cookie often consists of a string of numbers and letters that uniquely identifies your computer, but it can contain other information as well.') }}
        </p>
        <p class="py-3 text-lg text-gray-500">
        ...
        <div class="w-10 h-0.5 bg-yellow-600"></div>
        <p class="py-3 text-lg text-gray-500">
            {{ _trans("ScienceSoft is intended to deliver its services  to organizations. Your use of ScienceSoft’s website may be subject to your organization's policies, if any. If your organization is administering your use of ScienceSoft’s website, please direct your privacy inquiries to your administrator. ScienceSoft is not responsible for the privacy or security practices of our customers, which may differ from those set forth in this privacy statement.") }}
        </p>
        <p class="py-3 text-lg text-gray-500">
        ...
        <ul class="list-disc pl-5">
            ...
            <li class="py-2 text-lg text-gray-500">
                {{ _trans('Is ScienceSoft subject to a legal, contractual, or similar obligation to retain the data? Examples can include mandatory data retention laws in the applicable jurisdiction, government orders to preserve data relevant to an investigation, or data that must be retained for the purposes of litigation.') }}
            </li>
        </ul>
