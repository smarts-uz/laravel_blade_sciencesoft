...
@section('main')
 ...
 <div class="px-10 md:px-16 mb-10 lg:px-36 flex flex-col justify-center items-center text-center mt-20">
  <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-900 font-semibold">{{ _trans("SOFTWARE CONSULTING AND DEVELOPMENT FOR YOUR DIGITAL SUCCESS")  }}</h1>
  <hr class="w-20 h-1 bg-yellow-600 my-10 ">
  <p class="text-center text-base sm:text-lg md:text-xl lg:text-2xl leading-10 text-gray-700 ">{{ _trans("For over 31 years.
...
<div class="container mb-24">
  ...
  <div class="px-16 home-page-form-1">
    <h1 class="text-center text-gray-500 mt-10 mb-20 text-xl">{{ _trans("Haven't found a suitable service? Type your need below!")  }}</h1>
    <!-- Forms -->
    <form class="border-2 border-gray-500 flex flex-row rounded-full p-4 mb-20">
      ...
      <input type="search" name="Search" class="w-full border-none outline-none" placeholder="{{ _trans("E.g., VR development or help desk services")  }}"/>
    </form>
    ...
    <div class="flex flex-col-reverse lg:flex-row justify-between items-center px-5 py-12 bg-gray-100">
       <div class="w-full lg:w-3/5 mt-10 lg:mt-0">
         <h1 class="text-3xl font-semibold">{{ _trans("EVERY ASPECT OF YOUR IT ECOSYSTEM. TAKEN CARE OF.")  }}</h1>
         <p class="text-xl text-gray-700 my-6">{{ _trans("Comprehensive care of your cloud or on-premises infrastructure and applications with:")  }}</p>
  ...
  <div>
    ...
    <button class="border-2 border-blue-700 text-blue-700 font-semibold px-6 py-3 uppercase my-8 mx-auto">{{ _trans("All Blog Articles")  }}</button>
  </div>
  @endisset
  <!-- Need a CONSULTATION? -->
  </div>
