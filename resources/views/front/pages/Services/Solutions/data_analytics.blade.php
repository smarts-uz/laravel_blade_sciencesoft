...
@section('main')
    ...
    <div class="mx-6 md:mx-16 lg:mx-24 my-10">
        <div class="text-2xl md:text-4xl font-bold mt-6">
            {{ _trans("Data Analytics Services")  }}
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>{{ _trans("Tired of Time-Consuming Instinct-Based Decisions?")  }}
                    </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
                <p class='text-gray-600 text-xl'>{{ _trans("Within a reasonable time, ScienceSoft will help you defeat fragmented and
        ...
        <div class="text-2xl md:text-4xl font-bold mt-6">
            {{ _trans("WHAT YOU GET WITH DATA ANALYTICS SERVICES")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
            <p class="my-8 text-xl font-normal">
                {{ _trans("We are ready to implement our best data analytics practices to empower companies with informed
...
<div class="swiper-container about-slide h-40">
        ...
        <div>
            <ul class="list-disc text-base md:text-lg leading-loose">
                <li class="my-8">
                    31 {{ _trans("years in data analytics and data science.")  }}
                </li>
                <li class="my-8">
                    {{ _trans("15 years of experience in rendering data warehouse services, designing and implementing business
                    intelligence solutions.")  }}
                </li>
                <li class="my-8">
                    {{ _trans("Traditional BI and big data projects with the use of Microsoft Power BI since 2016.")  }}
                </li>
                <li class="my-8">
                    7 {{ _trans("years of big data consulting and implementation practice.")  }}
                </li>
                <li class="my-8">
                    {{ _trans("A multifunctional team of data analytics experts who can deliver agile solutions of different complexity
                    levels.")  }}
                </li>
            </ul>
        </div>
        ...
        <p class="text-xl">
            {{ _trans("Customized analytical solutions we design and implement allow our customers to achieve up to:")  }}
        </p>
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>{{ _trans("Wonder Whether Your Data Analytics Investments Will Pay Off?")  }}
                    </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
                <p class='text-gray-600 text-xl'>{{ _trans("ScienceSoft is ready to calculate your ROI so that you eliminate the
                guesswork in figuring out the value of your data analytics project.")  }}
                </p>
            </div>
            <div class='w-2/5 m-0 flex justify-center items-center'>
                <a href="#" class='px-4 py-3  text-center bg-blue-800 text-white uppercase hover:bg-blue-900'>{{ _trans("Get my data
                analytics ROI")  }}</a>
            </div>
        </div>
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
        ...
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ _trans("CHOOSE YOUR DATA ANALYTICS SERVICE OPTION")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        ...
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ _trans("SUCCESS STORIES ON DATA ANALYTICS")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        <div class="rounded-sm bg-gray-50 relative transition-shadow p-2 md:p-8">
            <div class="flex flex-col md:flex-row items-start ">
                ...
                <div class=" flex flex-col w-4/5 mb-10">
                    <h1 class="text-3xl md:text-4xl font-bold">{{ _trans("Big Data Implementation for Advertising Channel Analysis in
                    10+ Countries")  }}</h1>
        ...
        <div class="text-2xl md:text-4xl font-bold mt-20 mb-8">
            {{ _trans("NOT READY TO GIVE AWAY THESE DATA ANALYTICS BENEFITS?")  }}
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        <div>
            <ul class="list-disc text-base md:text-lg leading-loose">
                <li class="my-8">
                    {{ _trans("Elimination of the guesswork out of your business processes.")  }}

                </li>
                <li class="my-8">
                    {{ _trans("Faster and accurate reporting, analysis and planning.")  }}
                </li>
                <li class="my-8">
                    {{ _trans("Identification of profit opportunities.")  }}
                </li>
                <li class="my-8">
                    {{ _trans("Enhanced customer experience.")  }}
                </li>
            </ul>
        </div>
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
