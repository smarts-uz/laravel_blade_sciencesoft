...
@section('main')
    ...
    <div>
        ...
        <div class="flex flex-col justify-center items-center text-center">
            ...
            <p class="text-center text-base sm:text-lg md:text-xl lg:text-xl leading-10 text-gray-700 ">At its core,
                ...
                growth.</p>
            <div class="flex justify-between w-4/5 my-5">
                <div class="border-l-2 w-1/3 border-gray-200 px-2">
                    <h1 class="text-blue-500 text-3xl">Located in the UZB</h1>
                    <p class="text-2xl text-gray-400">international presence in Europe and the Middle East</p>
                </div>
                <div class="border-l-2 w-1/3 border-gray-200 px-2">
                    <h1 class="text-blue-500 text-3xl">17 years</h1>
                    <p class="text-2xl text-gray-400">in ecommerce services</p>
                </div>
                <div class="border-l-2 w-1/3 border-gray-200 px-2">
                    <h1 class="text-blue-500 text-3xl">700+ talents</h1>
                    <p class="text-2xl text-gray-400">across diverse IT domains</p>
                </div>
            </div>
        ...
        <div>
            ...
            <div class='flex flex-row flex-wrap justify-evenly'>
                ...
                <div
                    ...
                    <h1 class="text-center font-bold text-xl mb-2">VR Technology: Architecture, Tools, Team, and Costs
                    </h1>
            ...
            <div class='my-10 flex flex-row flex-wrap justify-between'>
                <div
                    ...
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base mb-5">
                            Business & tech tips for a successful online launch: business models, competitive advantages
                            and
                ...
                <div
                    ...
                    <div class="px-6 py-4">
                        <p class="text-grey-darker text-base">
                            Functional portfolio of ecommerce platforms and top 10 shortlisted by Smart Software.
                        </p>
                    </div>
                </div>
            </div>
