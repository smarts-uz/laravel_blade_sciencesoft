    ...
    <div class="my-10">
        ...
        <div>
            ...
            <p class="my-5 text-lg">
                <b>{{ _trans('.NET') }}</b>
                {{ _trans('is a programming language with powerful tools for web, mobile and desktop development. It is supported by the robust Microsoft ecosystem and allows building applications suitable for any device and platform.') }}
            </p>
            <p class="my-5 text-lg">
                ...
                <div class="pt-12">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-row">
                            ...
                            <p class="text-lg">
                                8
                                {{ _trans('Gold Microsoft Competencies: Application Development, Application Integration, Cloud Platform, Data Platform, Datacenter, Data Analytics, Messaging, Collaboration and Content.') }}
                            </p>
                        </div>
                        <div class="flex flex-row">
                            <span class="text-blue-600 mr-4">&#9632;</span>
                        ...
                        <div class="flex flex-row">
                            ...
                            <p class="text-lg">
                                25
                                {{ _trans('of our .NET developers have Microsoft Certified Technology Specialist (MCTS) and Microsoft Certified Professional Developer (MCPD) certifications.') }}
                            </p>
                        </div>
                        <div class="flex flex-row">
                            <span class="text-blue-600 mr-4">&#9632;</span>
        ...
        <div>
            ...
            <div class="flex md:flex-row flex-col">
                ...
                <div class="border-2 md:w-1/2 w-full my-1 mx-2 p-3">
                    ...
                    <p class="mt-8">
                        {{ _trans('DevOps culture and sustainable architectural decisions help us meet deadlines and introduce changes fast without compromising on the quality of our work even under the most challenging conditions.') }}
                    </p>
                </div>
                <div class="border-2 md:w-1/2 w-full my-1 mx-2 p-3">
                    <img class="w-14 my-8"
                    ...
                    <p class="mt-8">
                        {{ _trans('We help leverage the power of IoT, big data and AI in advanced .NET-based applications.') }}
                    </p>
                </div>
                ...
                <div class="rounded border-2 transition-shadow hover:shadow-lg md:w-1/2 w-full md:m-4 m-0 mt-2">
                    ...
                    <div class="p-4 h-96 flex flex-col justify-between">
                        <div>
                            ...
                            <p class="mb-3">
                                {{ _trans('We help choose the right technologies for your future .NET-based application or solve tech problems with an existing application by:') }}</b>
                            </p>
                        ...
                        <button
                            class="bg-blue-700 text-white w-full mt-3 uppercase p-3">{{ _trans('Contact us') }}</button>
                    </div>
                </div>
                <div class="rounded border-2 transition-shadow  hover:shadow-lg md:w-1/2 w-full md:m-4 m-0 mt-2">
                    <hr class="w-full border-t-4 border-blue-800" />
                    <div class="p-4 h-96 flex flex-col justify-between">
                        <div>
                            ...
                            <p class="mb-3">
                                {{ _trans('Drawing on your needs, we can suggest either an offshore dedicated team or team augmentation model of cooperation to back up your .NET development project or migration of legacy software to .NET. We offer pre-vetted developers, which match your requirements – you’re free to screen them before the start of cooperation.') }}
                            </p>
                        </div>
        ...
        <div>
            ...
            <p class="mt-5 text-lg">
                {{ _trans('We choose the architecture that will perfectly suit the needs of your future application:') }}
            </p>
            ...
            <div class="mt-7 flex md:flex-row flex-col justify-center md:justify-start">
                <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg md:w-1/3 w-full my-2 h-auto mr-10">
                    ...
                    <div class="p-4">
                        ...
                        <p>{{ _trans('For mid-sized applications to ensure their fast development, easy testing and maintenance.') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg md:w-1/3 w-full my-2 h-auto mr-10">
                    ...
                    <div class="p-4">
                        ...
                        <p>{{ _trans('For building a brand-new application, adding new components to the existing microservices infrastructure, or refactoring a monolith application. Microservices are a good fit for increased load and needs, continuous deployment, and partial updates.') }}
                        <p>
                    </div>
                </div>
                ...
                <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg md:w-1/3 w-full my-2 h-auto mr-10">
                    ...
                    <div class="p-4">
                        ...
                        <p>{{ _trans('To enhance your application with Microsoft Azure Cloud Services and specialized API. You’ll get a modern cloud app with maximal scalability and availability and benefit from significantly reduced operational costs.') }}
                        <p>
                    </div>
                </div>
        ...
        <div>
            ...
            <p class="mt-5 text-lg mb-5">
                {{ _trans('We provide comprehensive code documentation and carry out consistent code reviews to write code once and keep it simple, loose-coupled, balanced, and readable.') }}
            </p>
            <h3 class="font-bold text-xl mb-5">{{ _trans('…because it does matter') }}</h3>
            <p class="mt-5 text-lg">
                {{ _trans('Respectively, you get faster bug detection, stable application work, undemanding maintenance, and easier future updates.') }}
            </p>
        </div>
        ...
        <div
            ...
            <div class='md:w-1/3 w-full m-0 flex justify-center mt-5 md:mt-0 items-center'>
                <a href="#"
                    class='px-8 rounded py-3 bg-blue-700 text-white uppercase hover:bg-blue-900'>{{ _trans('Contact us') }}</a>
            </div>
        </div>
    </div>
