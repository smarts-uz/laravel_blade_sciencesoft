  ...
  <div class="w-full px-10 flex flex-col lg:flex-row lg:px-16 mb-10">
    ...
    <div class="w-full lg:w-4/5 px-6">
      <div class="flex flex-row text-gray-400 text-sm">
        <a href="/" class='text-gray-500'>{{ @translate_lang("Home")  }}</a>
        <p class='mx-2'>></p>
        <p>{{ @translate_lang("Software Development")  }}</p>
      </div>
      <h1 class='text-gray-900 mt-6'>
        <p class='text-5xl font-bold'>{{ @translate_lang("Software Development Services")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <img src="https://www.scnsoft.com/software-development-services/sciencesoft-software-development-services.svg" alt="">
      <p class='text-gray-700 text-xl mt-2'><strong>{{ @translate_lang("Invent, build, integrate, scale")  }}</strong> {{ @translate_lang("and")  }} <strong>{{ @translate_lang("upgrade")  }}</strong> {{ @translate_lang("your applications with ScienceSoft! For more than three decades, ScienceSoft has been harnessing digital technologies for the benefit of Fortune 500 businesses, mid and large enterprises, and startups across the variety of industries. Fully in the art and science of software engineering and management, we help you to build high-quality software solutions and products as well as deliver a wide range of related professional services.")  }}</p>
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ @translate_lang("WHAT SERVICE ARE YOU LOOKING FOR?")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <ul class='w-full flex flex-row flex-wrap'>
        <li class="rounded-sm border-2 transition-shadow hover:shadow-lg w-2/6 my-3">
          ...
          <div class="w-full px-4 py-8">
            <h1 class="text-xl font-semibold text-center text-blue-700 mb-3">{{ @translate_lang("Software Consulting")  }}</h1>
            <p class='text-gray-600 mb-10'>{{ @translate_lang("A holistic set of")  }} <strong>{{ @translate_lang("consulting services for both new and ongoing software development projects")  }}</strong> {{ @translate_lang("– from ideation and feasibility study to implementation strategy.")  }}</p>
            <div  class='uppercase w-full py-3 text-center bg-blue-700 text-white hover:bg-blue-900'>
              <a href="#">{{ @translate_lang("Check Details")  }}</a></div>
          </div>
        </li>
        <li class="rounded-sm border-2 transition-shadow hover:shadow-lg w-2/6 my-3">
          <hr class="w-full h-2 border-none bg-blue-800" />
      ...
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ @translate_lang("SOFTWARE WE DEVELOP")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <ul class='w-full flex flex-row flex-wrap'>
      ...
      <ul style="list-style: square" class='text-blue-500 text-xl'>
        <li><p class='text-gray-700'> <strong>31 {{ @translate_lang("years")  }}</strong> {{ @translate_lang("in IT.")  }}</p></li>
        <li><p class='text-gray-700'> {{ @translate_lang("One-stop shop for")  }} <strong>{{ @translate_lang("end-to-end")  }}</strong> {{ @translate_lang("software development.")  }}</p></li>
        <li><p class='text-gray-700'> {{ @translate_lang("Over")  }} <strong>450 {{ @translate_lang("developers")  }}</strong> {{ @translate_lang("on board, and the partner network of")  }} <span class='text-gray-700'>5 {{ @translate_lang("companies with 700 employees.")  }}</span></p></li>
        <li><p class='text-gray-700'> {{ @translate_lang("More than 50% of the developers are of")  }} <strong>{{ @translate_lang("senior level.")  }}</strong></p></li>
        <li><p class='text-gray-700'> 25+ {{ @translate_lang("business analysts with")  }} <strong>5-9 {{ @translate_lang("years")  }}</strong> {{ @translate_lang("of experience in the relevant fields.")  }} </p></li>
        <li><p class='text-gray-700'> {{ @translate_lang("Mature")  }} <strong>{{ @translate_lang("DevOps culture")  }}</strong>, {{ @translate_lang("deep background in")  }} <strong>{{ @translate_lang("containerized environments, cloud computing, continuous integration")  }}</strong> {{ @translate_lang("(CI) and")  }} <strong>{{ @translate_lang("continuous delivery")  }}</strong> {{ @translate_lang("(CD).")  }}</p></li>
        <li><p class='text-gray-700'> <strong>2,695</strong> {{ @translate_lang("success stories (including projects for Walmart, eBay, NASA JPL, PerkinElmer, Baxter, IBM, Leo Burnett).")  }}</p></li>
      </ul>
      <div class="container">
        <section class="customer-logos slider">
            <div class="slide"><img class="h-32 w-32" src="/images/deloitte.svg" alt="logo"></div>
      ...
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ @translate_lang("WE EAGERLY PUT IN USE IT INNOVATIONS")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <ul class='text-black flex flex-wrap flex-row'>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p>{{ @translate_lang("Artificial Intelligence")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p>{{ @translate_lang("Data Science")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p>{{ @translate_lang("Internet of Things")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p>{{ @translate_lang("Computer Vision")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p>{{ @translate_lang("Augmented Reality")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p>{{ @translate_lang("Virtual Reality")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
      ...
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ @translate_lang("TECHNOLOGIES WE USE")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <p class='text-xl text-gray-600'>{{ @translate_lang("We employ the proven combination of the latest and classic trusted technologies, having the following technology stack as our basis:")  }}</p>
      ...
      <div class="carousel relative shadow-2xl bg-white py-10 block lg:hidden">
        <div class="carousel-inner relative overflow-hidden w-full">
          ...
          <!-- {{ @translate_lang("Add additional indicators for each slide")  }}-->
      ...
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ @translate_lang("WE HAVE A TRACK OF SUCCESSFUL PROJECTS IN VARIOUS INDUSTRIES")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <p class='text-gray-800 text-xl'>{{ @translate_lang("We developed integrated solutions and provided IT consulting services for leading enterprises and startups around the globe.")  }}</p>
      <ul class='text-black flex flex-wrap flex-row'>
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("Manudacturing")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("HealthCare")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("Retail")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("Banking and Financial Services")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("Telecoms")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("Oil and Gas")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("Entertainment")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
        ...
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
            <p class='font-semibold'>{{ @translate_lang("Logistics and Transportation")  }}</p>
            <div class="absolute bottom-3 rotate-45 right-3">
              <i class="fa fa-arrow-right"></i>
            </div>
          </a>
      ...
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ @translate_lang("SELECTED PROJECTS")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <div class="bg-gray-100 flex items-start">
        <div class="flex flex-row">
          ...
          <div class="relative flex flex-col py-6">
            <h1 class="text-2xl md:text-2xl font-bold">{{ @translate_lang("Big Data Implementation for Advertising Channel Analysis in 10+ Countries")  }}</h1>
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
            <p class=" text-gray-500 text-sm mb-6 md:text-xl">
              {{ @translate_lang("Migration to a new analytical system that ScienceSoft implemented helped one of the top market research companies secure an innovative big data solution based on Apache Hadoop, Apache Hive and Apache Spark frameworks. The new system was 100 times faster compared to the old one and could process 1,000 different data formats.")  }}
            </p>
            <a href="#" class='absolute bottom-3 right-2 text-xl text-blue-500 hover:text-blue-800'>{{ @translate_lang("Learn More")  }} -></a>
          </div>
        </div>
      </div>
      ...
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ @translate_lang("WHAT DEFINES MODERN SOFTWARE DEVELOPMENT?")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <div class='flex justify-between'>
        <div class='border px-4 py-6'>
          <h1 class='text-xl font-bold text-gray-800'>{{ @translate_lang("Practices for speeding up development")  }}</h1>
          <ul style='list-style: square' class='flex flex-col text-xl text-blue-500 px-5'>
            <li>
              <p class=text-gray-600>{{ @translate_lang("Agile development")  }}</p>
            </li>
            <li>
              <p class=text-gray-600>{{ @translate_lang("Quality at every stage of the software development cycle")  }}</p>
            </li>
            <li>
              <p class=text-gray-600>{{ @translate_lang("Microservices/container-based architecture")  }}</p>
            </li>
            <li>
              <p class=text-gray-600>{{ @translate_lang("DevOps (CI/CD)")  }}</p>
            </li>
            <li>
              <p class=text-gray-600>{{ @translate_lang("Test automation and test-driven development (TDD)")  }}</p>
            </li>
          </ul>
          <div class='w-full py-2 bg-blue-700 text-white flex justify-center items-center text-xl mt-6 hover:bg-blue-900'>
            <a href="#" class=''>{{ @translate_lang("Provide me process description")  }}</a>
          </div>
        </div>
