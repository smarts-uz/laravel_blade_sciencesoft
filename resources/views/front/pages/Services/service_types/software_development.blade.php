  ...
  <div class="w-full px-10 flex flex-col lg:flex-row lg:px-16 mb-10">
    ...
    <div class="w-full lg:w-4/5 px-6">
      ...
      <ul class='w-full flex flex-row flex-wrap'>
        <li class="rounded-sm border-2 transition-shadow hover:shadow-lg w-2/6 my-3">
          ...
          <div class="w-full px-4 py-8">
            <h1 class="text-xl font-semibold text-center text-blue-700 mb-3">{{ _trans("Software Consulting")  }}</h1>
            <p class='text-gray-600 mb-10'>{{ _trans("A holistic set of")  }} <strong>{{ _trans("consulting services for both new and ongoing software development projects")  }}</strong> {{ _trans("– from ideation and feasibility study to implementation strategy.")  }}</p>
            <div  class='uppercase w-full py-3 text-center bg-blue-700 text-white hover:bg-blue-900'>
              <a href="#">{{ _trans("Check Details")  }}</a></div>
          </div>
        </li>
        <li class="rounded-sm border-2 transition-shadow hover:shadow-lg w-2/6 my-3">
          <hr class="w-full h-2 border-none bg-blue-800" />
      ...
      <ul style="list-style: square" class='text-blue-500 text-xl'>
        <li><p class='text-gray-700'> <strong>31 {{ _trans("years")  }}</strong> {{ _trans("in IT.")  }}</p></li>
        <li><p class='text-gray-700'> {{ _trans("One-stop shop for")  }} <strong>{{ _trans("end-to-end")  }}</strong> {{ _trans("software development.")  }}</p></li>
        <li><p class='text-gray-700'> {{ _trans("Over")  }} <strong>450 {{ _trans("developers")  }}</strong> {{ _trans("on board, and the partner network of")  }} <span class='text-gray-700'>5 {{ _trans("companies with 700 employees.")  }}</span></p></li>
        <li><p class='text-gray-700'> {{ _trans("More than 50% of the developers are of")  }} <strong>{{ _trans("senior level.")  }}</strong></p></li>
        <li><p class='text-gray-700'> 25+ {{ _trans("business analysts with")  }} <strong>5-9 {{ _trans("years")  }}</strong> {{ _trans("of experience in the relevant fields.")  }} </p></li>
        <li><p class='text-gray-700'> {{ _trans("Mature")  }} <strong>{{ _trans("DevOps culture")  }}</strong>, {{ _trans("deep background in")  }} <strong>{{ _trans("containerized environments, cloud computing, continuous integration")  }}</strong> {{ _trans("(CI) and")  }} <strong>{{ _trans("continuous delivery")  }}</strong> {{ _trans("(CD).")  }}</p></li>
        <li><p class='text-gray-700'> <strong>2,695</strong> {{ _trans("success stories (including projects for Walmart, eBay, NASA JPL, PerkinElmer, Baxter, IBM, Leo Burnett).")  }}</p></li>
      </ul>
      <div class="container">
        <section class="customer-logos slider">
            <div class="slide"><img class="h-32 w-32" src="/images/deloitte.svg" alt="logo"></div>
      ...
      <p class='text-xl text-gray-600'>{{ _trans("We employ the proven combination of the latest and classic trusted technologies, having the following technology stack as our basis:")  }}</p>
        ...
        <div class="carousel-inner relative overflow-hidden w-full">
          ...
          <div class="carousel-item absolute opacity-0">
            ...
            <div class="block h-full w-full text-xl pb-10">
              ...
              <p class="my-8 text-gray-600">{{ _trans("The development of reliable and scalable software solutions for any OS, browser and
              device.
              We bring
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-800 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Software consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black  hover:text-blue-500">{{ _trans("Custom software development")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black  hover:text-blue-500">{{ _trans("Software product development")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Team augmentation")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Software development outsourcing")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            ...
            <div class="block h-full w-full pb-10 text-xl">
              ...
              <p class="my-8 text-gray-600">{{ _trans("We apply our 10-year experience to offer a full set of infrastructure services. We can
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-800 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Managed IT Support")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Data center support and management")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Cloud consulting and management")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("DevOps consulting and implementation")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Virtual desktop consulting, implementation and support")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Networking management services")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            ...
            <div class="block h-full w-full text-xl pb-10">
              ...
              <p class="my-8 text-gray-600">{{ _trans("The full set of services around development and maintenance of complex business-critical
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-500 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application management")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application modernization")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application integration")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application security services")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application development")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application testing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application maintenance and support")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            ...
            <div class="block h-full w-full text-xl pb-20">
              ...
              <p class="my-8 text-gray-600">{{ _trans("User experience and user interface design for all types of websites, SaaS, and
              web/mobile
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-500 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("User Interface (UI) Design")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Responsive Web App Design")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Software-as-as-Service (SaaS) UI Design")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Ecommerce Website Design")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("User Experience (UX) Design")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Website Redesign")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Responsive Web Design")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            <div class="block h-full w-full text-xl pb-10">
              ...
              <p class="my-8 text-gray-600">{{ _trans("We offer full-range QA and testing outsourcing services, can help to develop your QA or
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-500 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("QA outsourcing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("QA consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Security testing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Functional testing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Usability testing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Performance testing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Test automation")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            <div class="block h-full w-full text-xl pb-10">
              ...
              <p class="my-8 text-gray-600">{{ _trans("Our experts can help to develop and implement an effective IT strategy, assist in smooth
              digital transformation and
              system integration as well as advise on improvements to your digital customer experience.")  }}</p>
              <ul class="flex flex-row flex-wrap ml-6 text-blue-500 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black">{{ _trans("Digital Transformation Consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Project Management Consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Digital Crisis Management Consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("IT Service Management Consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Solution consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Platform consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Enterprise IT consulting")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            <div class="block h-full w-full text-xl pb-10">
              ...
              <p class="my-8 text-gray-600">{{ _trans("We support businesses in achieving fact-based decision-making by converting their
              historical
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-500 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Business Intelligence")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Big Data")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Data Warehousing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Data Science")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Data Management")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Machine and Deep Learning")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Data Analytics as a Service")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            <div class="block h-full w-full text-xl pb-10">
              ...
              <p class="my-8 text-gray-600">{{ _trans("Help desk services for your IT environment or software products. We take on solving
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-500 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Help desk outsourcing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("IT help desk services")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Outsourced help desk for MSP")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("NOC outsourcing")  }}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="carousel-item absolute opacity-0">
            <div class="block h-full w-full text-xl pb-10">
              ...
              <p class="my-8 text-gray-600">{{ _trans("Cybersecurity services to achieve the robust protection of the companies’ applications
              and
              ...
              <ul class="flex flex-row flex-wrap ml-6 text-blue-600 underline">
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Managed security services")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Compliance testing")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Information security consulting")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Security code review")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Application security implementation")  }}</a>
                </li>
                <li style="list-style: square; margin-right: 10px; margin-bottom: 20px; width: 350px;">
                  <a href="#" class="text-black hover:text-blue-500">{{ _trans("Vulnerability assessment and penetration testing")  }}</a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div class="p-4 flex-auto lg:h- h-auto">
                <div class="tab-content tab-space p-8">
                  <div class="block text-xl pb-10" id="software-development">
                    ...
                    <p class="my-8 text-gray-600">{{ _trans("The development of reliable and scalable software solutions for any OS, browser and device.
                    We bring
                    together deep industry expertise and the latest IT advancements to deliver custom solutions and products
                    that perfectly fit the
                    needs and behavior of their users.")  }}</p>
                  ...
                  <div class="hidden text-xl pb-10" id="infrastructure-services">
                    ...
                    <p class="my-8 text-gray-600">{{ _trans("We apply our 10-year experience to offer a full set of infrastructure services. We can help
                    to maintain
                  ...
                  <div class="hidden text-xl pb-10" id="application-services">
                    <h1 class="text-3xl font-semibold"><p class="mb-2">{{ _trans("Application Services")  }}</p>
                      <hr class="w-10 h-1 bg-pink-600">
                    </h1>
                    <p class="my-8 text-gray-600">{{ _trans("The full set of services around development and maintenance of complex business-critical
                    applications. Our experts
                  ...
                  <div class="hidden text-xl pb-20" id="ux-ui-design">
                    <h1 class="text-3xl font-semibold"><p class="mb-2">{{ _trans("UX/UI Design")  }}</p>
                      <hr class="w-10 h-1 bg-pink-600">
                    </h1>
                    <p class="my-8 text-gray-600">{{ _trans("User experience and user interface design for all types of websites, SaaS, and web/mobile
                    apps. We combine the latest
                    UI/UX trends with our customers’ individual goals and needs to deliver intuitive, vibrant, and impactful
                    designs that
                    power up businesses.")  }}</p>
                  ...
                  <div class="hidden text-xl pb-10" id="testing-qa">
                    <h1 class="text-3xl font-semibold"><p class="mb-2">{{ _trans("Testing & QA")  }}</p>
                      <hr class="w-10 h-1 bg-pink-600">
                    </h1>
                    <p class="my-8 text-gray-600">{{ _trans("We offer full-range QA and testing outsourcing services, can help to develop your QA or
                    enhance the existing one, assist
                  ...
                  <div class="hidden text-xl pb-10" id="it-consulting">
                    <h1 class="text-3xl font-semibold"><p class="mb-2">{{ _trans("IT Consulting")  }}</p>
                      <hr class="w-10 h-1 bg-pink-600">
                    </h1>
                    <p class="my-8 text-gray-600">{{ _trans("Our experts can help to develop and implement an effective IT strategy, assist in smooth
                            digital transformation and
                  ...
                  <div class="hidden text-xl pb-10" id="data-analytics">
                    <h1 class="text-3xl font-semibold"><p class="mb-2">{{ _trans("Data Analytics")  }}</p>
                      <hr class="w-10 h-1 bg-pink-600">
                    </h1>
                    <p class="my-8 text-gray-600">{{ _trans("We support businesses in achieving fact-based decision-making by converting their historical
                    and real-time, traditional
                    and big data into actionable insights. Our services are tailored to make the raw data and the environment
                    ready, as well
                    as strengthen the business with advanced analytics capabilities.")  }}</p>
                  ...
                  <div class="hidden text-xl pb-10" id="help-desk-services">
                    <h1 class="text-3xl font-semibold"><p class="mb-2">{{ _trans("Help Desk Services")  }}</p>
                      <hr class="w-10 h-1 bg-pink-600">
                    </h1>
                    <p class="my-8 text-gray-600">{{ _trans("Help desk services for your IT environment or software products. We take on solving diverse
                  ...
                  <div class="hidden text-xl pb-10" id="cybersecurity-services">
                    <h1 class="text-3xl font-semibold"><p class="mb-2">{{ _trans("Cybersecurity Services")  }}</p>
                      <hr class="w-10 h-1 bg-pink-600">
                    </h1>
                    <p class="my-8 text-gray-600">{{ _trans("Cybersecurity services to achieve the robust protection of the companies’ applications and
                    networks. Equipped with
                    16-year experience in information security, our security experts are ready to deliver a variety of cyber
                    protection
                    services.")  }}</p>
      ...
      <h1 class='text-gray-900 mt-6'>
        <p class='text-3xl font-bold'>{{ _trans("WE HAVE A TRACK OF SUCCESSFUL PROJECTS IN VARIOUS INDUSTRIES")  }}</p>
        <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
      </h1>
      <p class='text-gray-800 text-xl'>{{ _trans("We developed integrated solutions and provided IT consulting services for leading enterprises and startups around the globe.")  }}</p>
      <ul class='text-black flex flex-wrap flex-row'>
        <li class="bg-white xl:w-60 lg:w-40 md:w-48 w-2/5 border h-24 flex justify-center items-center text-center text-sm xl:text-xl m-2 relative">
          <a href="#">
      ...
      <div class="bg-gray-100 flex items-start">
        <div class="flex flex-row">
          ...
          <div class="relative flex flex-col py-6">
            <h1 class="text-2xl md:text-2xl font-bold">{{ _trans("Big Data Implementation for Advertising Channel Analysis in 10+ Countries")  }}</h1>
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
            ...
            <a href="#" class='absolute bottom-3 right-2 text-xl text-blue-500 hover:text-blue-800'>{{ _trans("Learn More")  }} -></a>
          </div>
        </div>
      </div>
      ...
      <div class='flex justify-between'>
        <div class='border px-4 py-6'>
          <h1 class='text-xl font-bold text-gray-800'>{{ _trans("Practices for speeding up development")  }}</h1>
          <ul style='list-style: square' class='flex flex-col text-xl text-blue-500 px-5'>
            ...
            <li>
              <p class=text-gray-600>{{ _trans("Quality at every stage of the software development cycle")  }}</p>
            </li>
            <li>
            ...
            <li>
              <p class=text-gray-600>{{ _trans("Test automation and test-driven development (TDD)")  }}</p>
            </li>
          </ul>
