    ...
    <section class="w-full p-4 pr-10">
        ...
        <div class="text-2xl md:text-4xl font-bold mt-6">
            ...
            <div>
                <p class="font-normal text-lg leading-loose mt-10">
                    IT support comprises procedures intended to maintain failsafe IT workflows and reduce IT costs.
        ...
        <div class="flex flex-row">
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/4 h-auto mr-10">
                <hr class="w-full " />
                <div class="p-4">
                    <p class="text-lg mb-3 text-center font-bold">Full-service IT outsourcing</p>
                    <p class="mb-3">Drawing on your needs, we can suggest either an offshore dedicated team or team
                        augmentation model of cooperation to back up your .NET development project or migration of
                        legacy software to .NET. We offer pre-vetted developers, which match your requirements –
                        you’re free to screen them before the start of cooperation.</p>
            ...
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-1/4 h-auto mr-10">
                <hr class="w-full " />
                <div class="p-4">
                    <p class="text-lg mb-3 text-center font-bold">Co-sourcing with an in-house IT team
                    </p>
                    <p class="mb-3">Outsource your entire IT landscape, including IT service planning and
                        management, to achieve greater business performance with IT ROI boosted by 50-300%.</p>
                    <p>
            ...
            <div class="rounded border-2 transition-shadow  hover:shadow-lg w-1/4 h-auto mr-10">
                <hr class="w-full  " />
                <div class="p-4">
                    <p class="text-lg mb-3 text-center font-bold">Co-sourcing with other vendors</p>
                    <p class="mb-3">Drawing on your needs, we can suggest either an offshore dedicated team or team
                        augmentation model of cooperation to back up your .NET development project or migration of
                        legacy software to .NET. We offer pre-vetted developers, which match your requirements –
                        you’re free to screen them before the start of cooperation.</p>
        ...
        <div class="flex flex-row">
            <div class="rounded-sm border-2 transition-shadow  hover:shadow-lg w-2/5 h-auto mr-10">
                <hr class="w-full border-t-4 border-blue-800" />
                <div class="p-4">
                    <p class="text-lg text-blue-700 mb-3 text-center font-bold">IT Help Desk</p>
                    <p class="mb-3 italic">White-label cooperation is possible.</p>
                    <p>L1, L2, L3 support for enterprises, software companies and MSPs.</p>
        ...
        <div class="my-20  mx-auto w-full font-bold">
            <div class="w-full  sm:flex sm:flex-row justify-start flex flex-col ">
                <div
                    ...
                    <p class="font-light text-gray-400 pl-2 mx-auto">user satisfaction</p>
                </div>
                <div
                    class="sm:w-1/4 sm:border-l sm:border-gray-300 w-full flex flex-col justify-center hover:border-b hover:border-gray-300">
                    <p class="text-4xl text-blue-800  pl-2 mx-auto">
                    ...
                    <p class="font-light text-gray-400 pl-2 mx-auto">app issues</p>
                </div>
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl my-16'>
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>Get Your Stable and Efficient IT with Least Effort! </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
                <p class='text-gray-600 text-xl'>ScienceSoft professionals will conduct close monitoring of your IT
                    infrastructure or its components and set up efficient IT support workflows. </p>
            </div>
            <div class='w-2/5 m-0 flex justify-center items-center'>
                <a href="#" class='px-4 py-3  text-center bg-blue-800 text-white uppercase hover:bg-blue-900'>launch
