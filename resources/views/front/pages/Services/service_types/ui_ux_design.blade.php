...
@section('main')
        ...
        <div class="mx-24 md:mx-16 mx-6 my-10">
          ...
          <p class="my-5 text-lg">
            {{ _trans("With over 31 years in Information Technology, we have built up
          ...
          <p class="my-5 text-lg">
            {{ _trans("We headquarter in McKinney, TX, US, have a European office in
        ...
        >
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            <h1 class="uppercase lg:text-3xl px-4 font-bold mt-10 text-2xl">
              {{ _trans("Competitive design")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600 m-4" />
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              {{ _trans("We combine your brand style and the latest web design trends,
        ...
        >
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            <h1 class="uppercase lg:text-3xl px-4 font-bold mt-10 text-2xl">
              {{ _trans("Focus on your business objectives")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600 m-4" />
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              {{ _trans("When working on a design of a website or web portal, our team
        ...
        >
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            <h1 class="uppercase lg:text-3xl px-4 font-bold mt-10 text-2xl">
              {{ _trans("Tailored to your target audience")  }}
            </h1>
            <hr class="w-12 border-b-2 border-yellow-600 m-4" />
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              {{ _trans("We perform in-depth analysis of your users' expectations at the
        ...
        <h1 class="uppercase font-bold mt-10 text-2xl">{{ _trans("Web Design Services")  }}</h1>
        <hr class="w-14 mt-3 bg-yellow-500 h-1" />
        <p class="text-gray-600 font-normal text-lg leading-9">
          {{ _trans("While providing the option of one-off web design, we also suggest
