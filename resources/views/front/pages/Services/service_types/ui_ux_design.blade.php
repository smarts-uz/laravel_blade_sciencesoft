...
@section('main')
        ...
        <div class="mx-24 md:mx-16 mx-6 my-10">
          ...
          <p class="my-5 text-lg">
            With over 31 years in Information Technology, we have built up
          ...
          <p class="my-5 text-lg">
            We headquarter in McKinney, TX, US, have a European office in
        ...
        >
          <div class="lg:w-full w-full mb-8">
            ...
            <div class="w-full px-4 flex flex-row mb-5">
              <span class="w-5 h-2 bg-blue-500 mt-3"></span>
              <p class="px-4 text-base sm:text-lg text-sm">
                Adherence to SEO and, if requested, WCAG2 regulations.
              </p>
            </div>
            <div class="w-full px-4 flex flex-row mb-5">
              <span class="w-5 h-2 bg-blue-500 mt-3"></span>
        ...
        <h1 class="uppercase font-bold mt-10 text-2xl">
          PERKS OF WEB DESIGN WITH SCIENCESOFT
        </h1>
        <div
        ...
        >
          ...
          <div class="lg:w-3/4 mx-auto w-11/12 mb-8">
            ...
            <br />
            <p class="px-4 text-base sm:text-lg text-sm">
              ScienceSoft’s web design services resulted in a 6x increase in
              conversions of a US telecom company’s website.
            </p>
          </div>
        </div>
        <h1 class="uppercase font-bold mt-10 text-2xl">Web Design Services</h1>
        <hr class="w-14 mt-3 bg-yellow-500 h-1" />
        <p class="text-gray-600 font-normal text-lg leading-9">
          While providing the option of one-off web design, we also suggest
