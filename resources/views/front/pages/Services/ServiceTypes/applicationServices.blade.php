...
<main class="flex w-full">
    <aside class="w-80 h-screen bg-gray w-fulll hidden sm:block">
      <div
    ...
    <section class="w-full p-4 pr-10">
      <div>
        ...
        End-to-end Application Services. Your Journey to Digital Transformation and Optimized TCO
        </h1>
       ...
       <a href="" class="bg-blue-500 font-bold text-white px-6 py-3 transition duration-300 ease-in-out hover:bg-blue-600 mr-6 float-right">CONTACT US</a>
      </div>
      <h1 class="uppercase font-bold mt-10 text-2xl">
        End-to-end Application Services. Your Journey to Digital Transformation and Optimized TCO
        </h1>
        <hr class="w-12 mt-5 border-yellow-400 h-4" />
        <p class="font-sans">Our concept of application services is outlined in the following points:</p>
      <ul class="list-disc ">
        <li class="pt-2"><strong>We use modern technologies and approaches. </strong>We eagerly utilize and constantly develop our competencies in IoT, big data, machine learning, AI, image analysis,&nbsp;AR, DevOps/Continuous Delivery (CD), and don’t shun proven and long-trusted techs. &nbsp;&nbsp;&nbsp;</li>
        <li class="pt-2"><strong>We know how to deal with complex enterprise IT landscapes</strong> that have evolved for decades. For 31&nbsp;years, we’ve been accumulating the experience from multiple projects and learned the tricks to tame the systems of various nature a<span>nd architectural&nbsp;patterns. </span></li>
        <li class="pt-2"><strong><span>We are flexible in terms of cooperation</span></strong><span>. We are ready to cooperate with third-party vendors and together deliver business value to the customers. If the customer’s needs and priorities change, we can adjust the responsibility scope on the go and adapt service timelines to the new context.&nbsp;</span></li>
        <li class="pt-2"><strong><span>We focus on TCO of the solutions we deliver and manage.</span></strong><span> We analyze how to optimize operational, maintenance, and other costs during a solution’s life cycle. &nbsp;</span></li>
      </ul>
      <h1 class="uppercase font-bold mt-10 text-2xl">
      APPLICATION SERVICES WE OFFER
      </h1>
      <hr class="w-12 mt-5 border-yellow-400 h-4"/>
      <p class="font-sans ">ScienceSoft offers the following set of application services for midsized and big enterprises:</p>
      ...
      <h1 class="uppercase font-bold pt-6  text-2xl">Application development</h1>
      <p class="pt-4">We design and deliver web, mobile and cloud business applications of different complexity and for various needs. In the process, we pay special attention to their flexibility, security, speed and integration potential.</p>
      <p class="pt-4">The success of our software comes from:</p>
      <!-- ul -->
    ...
    <div class="rounded-sm  relative pt-2 ">
        <div class="flex flex-col md:flex-row ">
          ...
          <div class="flex flex-col w-4/5 mb-4">
            <strong class="">Tailored pricing plan</strong>     
    ...
    <section>
        <h2 class=" font-bold pt-6  text-2xl ">Application management </h2>
        <p class="pt-4 text-gray-600"><span>We can take responsibility for the management of your applications ensuring its increased business flexibility and optimized IT costs. With&nbsp;latest process management practices, our team will maintain and monitor your application servers and databases taking care of their enhanced performance, sustainability, stability and keepin them in sync with current business needs.</span></p>
        <p class="text-gray-600 pt-5"><span>The list of our application management services includes but is not limited to:</span></p>
    </section>
    ...
    <div class="rounded-sm  relative pt-5 ">
        ...
        <div class="flex w-16 text-xl mr-0 md:mr-8 mb-8 md:mb-0">
            ...
            <div class="flex flex-col w-4/5 mb-4">
                <strong class="">Remote application monitoring and performance management</strong>     
                <p class="text-gray-500 pt-2"><span>We take over the continuous remote diagnostics of your critical applications. We identify problems, share with you the detailed info on the causes of found issues and provide recommendations on the needed improvements. We track application performance, transaction integrity, data consistency, message queue exceeds, server failures.</span></p>
            </div> 
        </div>
    </div>
    <h1 class="uppercase font-bold pt-6  text-2xl">Application modernization</h1>
    <p class="pt-4 text-gray-600 w-4/5">Our team implements modernization of legacy applications to increase their efficiency and incorporate them better into a modern enterprise IT strategy.  </p>
    <p class="text-gray-600 pt-5"><span>We support a wide range of ‘revival’ activities and scale them according to your business needs.</span></p>
    
    <ul class="list-disc pt-2">
        <li class="pt-2"><strong>Re-hosting –</strong>moving an entire application from the on-premises or the old cloud infrastructure to the new cloud without significant modifications and changes in code. </li>
        <li class="pt-2"><strong>Re-hosting –</strong>moving an entire application from the on-premises or the old cloud infrastructure to the new cloud without significant modifications and changes in code. </li>
        <li class="pt-2"><strong>Re-hosting –</strong>moving an entire application from the on-premises or the old cloud infrastructure to the new cloud without significant modifications and changes in code. </li>
        <li class="pt-2"><strong>Re-hosting –</strong>moving an entire application from the on-premises or the old cloud infrastructure to the new cloud without significant modifications and changes in code. </li>
        <li class="pt-2"><strong>Re-hosting –</strong>moving an entire application from the on-premises or the old cloud infrastructure to the new cloud without significant modifications and changes in code. </li>
      ...
      <h1 class=" font-bold pt-6  text-2xl">Application integration</h1>
    <p class="pt-4 text-gray-600 w-4/5">We can transform multiple independent applications of your IT environment into one coherently working system allowing for its increased efficiency and user convenience.</p>
    <p class="text-gray-600 pt-5"><span>To make integration successful, we address our experience in integrating systems and applications of various complexity, scale and technology stacks and:</span></p>
    <div class="rounded-sm  relative pt-5 ">
        <div class="flex flex-col md:flex-row ">
        <div class="flex w-16 text-xl mr-0 md:mr-8 mb-8 md:mb-0">
            <img class="w-64 top-0" src="https://www.scnsoft.com/blue-icons-on-grey-background/business-specificity-half-solid.svg" alt="">
    ...
    <h1 class=" font-bold pt-6  text-2xl">Application security services</h1>
    <p class="pt-4 text-gray-600 w-4/5">Our security experts can assist enterprises in making their applications resistant to security threats.</p>
    <ul class="list-disc pt-2">
        <li class="pt-2">We help you to compile security requirements as well as recommend a resilient app design pattern that will be able to address potential security risks. </li>
      </ul>
      <h1 class=" font-bold pt-6  text-2xl ">Application testing</h1>
    <p class="pt-4 text-gray-600 w-4/5">We perform comprehensive manual and automated testing (vital for Continuous Delivery) for every stage of the application life cycle (implementation, deployment, support and evolution) to timely identify potential risks and verify that your enterprise solutions work correctly and correspond to the established quality requirements. </p>
    <p class="pt-4 text-gray-600 w-4/5">We ensure comprehensive checking of your application with multiple types of testing, including:</p>
    <!-- ul -->
      <div class="flex pt-4 flex-col w-full">
        <div class="border-2 text-center font-bold hover:shadow-2xl text-lg transition-shadow w-1/4 h-28 mr-10 p-7">Functional testing
        </div>
      </div>
    ...
    <div class="rounded-sm border-2 border-white shadow-2xl  transition-shadow w-full mr-20 p-8">
      <div class="flex flex-col">
        ...
        <button class="uppercase text-white bg-blue-700 py-2 px-4 w-2/5 mt-8 lg:w-1/5 text-center cursor-pointer">request a consultation</button>
      </div>
      </div>
    </div>
    <h1 class="pt-5 uppercase text-xl font-bold">SELECTED PROJECTS</h1>
    <hr class="w-12 border-b-2 border-yellow-600  my-4"/>
