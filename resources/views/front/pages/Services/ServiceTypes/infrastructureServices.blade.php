...
<main class="flex w-full">
    ...
    <section class="w-full p-4 pr-10">
        <div class="text-2xl md:text-4xl font-bold mt-6">
            ...
            <div>
                <p class="font-normal text-lg leading-loose mt-10">
                    ScienceSoft’s IT team delivers a full set of services to keep your IT infrastructure reliable
        ...
        <div class="text-2xl md:text-3xl font-bold uppercase">
            Why Collaborate with ScienceSoft
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>

        <ul class="list-outside list-disc bg-rose-200 text-xl leading-relaxed">
            <li class="mb-4"><strong>31 years </strong>in the IT industry.
            </li>
            <li>
                <strong>12 years</strong> of experience in ITSM.
            </li>
            <li>
                Recognized Microsoft Partner granted with <strong>8 Gold Competencies,</strong> including such
                infrastructure-specific competencies as Cloud Platform, Datacenter, Data Platform, and Messaging.
            </li>
            <li>
                <strong>AWS Select-Tier Consulting Partner</strong> in IoT and big data.
            </li>
            <li>
                An expert IT team holding a range of certificates, among which are <strong>AWS Certified Solution
                    Architect,
            ...
            <li>
                Ensuring pricing transparency and SLA flexibility.
            </li>

        </ul>

        <div class="text-2xl md:text-3xl font-bold mt-10">
            IT Infrastructure Services ScienceSoft Delivers
            <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
        </div>
        ...
        <p class="my-8 text-xl">
            We relieve you from the necessity to cope with various IT infrastructure issues with our consulting and
            ...
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    ...
                    <p class=" text-xl md:text-2xl">
                        Our team can assist you in determining your current IT infrastructure state, and further
                        help you build and realize an IT strategy aimed at improving your IT infrastructure
                        efficiency.
                    </p>
                    <p class=" text-xl md:text-2xl my-6">
                        ScienceSoft offers the following services in terms of IT infrastructure consulting:
                    </p>
                    <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
                        <li class="mb-4">Audit of the entire IT infrastructure according to the industry standards
                            if applicable (e.g., HIPAA, PCI DSS, GDPR). </li>
                        <li class="mb-4">Analysis of the IT infrastructure management processes based on ITIL
                            principles and their further optimization. </li>
                        <li class="mb-4">Designing a detailed plan to improve your IT infrastructure performance.
                        </li>
                        <li class="mb-4">Identifying operational issues and data protection risks and defining a way
                            to eliminate them. </li>
                        <li>
                            Providing consultations and trainings for your employees to improve their infrastructure
                            management skills.
                        </li>
                    </ul>
                </div>
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-3xl md:text-4xl font-bold">IT infrastructure management</h1>
                    <hr class="w-12 border-yellow-600 text-gray-800 my-4">
                    <p class=" text-xl md:text-2xl">
                    ...
                    <div class="ml-6">
                        <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
                            <li class="mb-4 text-2xl font-bold">IT infrastructure administration </li>
                            <p class="text-lg">
                                We apply our long-term experience in ITSM to maintain the performance of your
                                network,
                            ...
                            <li class="mb-4 text-2xl font-bold">IT infrastructure monitoring</li>
                            <p class="text-lg">
                                With the help of such tools as System Center Configuration Manager (for Windows
                            ...
                            <li class="mb-4 text-2xl font-bold">IT infrastructure troubleshooting </li>
                            <p class="text-lg">
                                ScienceSoft’s IT team offers you their 24/7 availability and readiness to mitigate
                                the issues related to your IT infrastructure scalability, its uptime, resource
                                utilization, storage use, and many more
                            </p>
                            <li class="mb-4 text-2xl font-bold">IT infrastructure evolution</li>
                            <p class="text-lg">
                                We are ready to take the overall responsibility for managing minor and critical
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-3xl md:text-2xl font-bold">Cloud infrastructure consulting</h1>

                    <p class=" text-xl md:text-2xl mt-6">
                        ScienceSoft’s team of certified cloud architects will help you to find a suitable approach
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-1xl md:text-2xl font-bold">Cloud infrastructure management</h1>
                    <p class=" text-xl md:text-2xl mt-4">
                        ScienceSoft’s cloud administrators can set up and maintain your cloud-based IT
                        infrastructure. Our experts provide cloud management services focusing on:
                    </p>
                    <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
                        <li class="mb-4">Properly setting up your cloud-based IT infrastructure. </li>
                        <li class="mb-4">Configuring and optimizing AWS, Azure, and other cloud services usage.
                        </li>
                        <li class="mb-4">Constantly monitoring your cloud-based IT infrastructure to detect problems
                            before your users do.
                        </li>
                        <li class="mb-4">Planning and further implementing changes and expansions meeting your needs
                            and requests. </li>
                        <li>
                            In case the applications managed by another vendor are concerned, cooperating with the
                            vendor, possibly applying the DevOps approach.
                        </li>
                        <li>
                            Providing you with consolidated billing (one bill for AWS services and our cloud
                            services).
                        </li>
                    </ul>
                </div>
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-3xl md:text-2xl font-bold">Cloud infrastructure monitoring</h1>

                    <p class=" text-xl md:text-2xl mt-6">
                        n case you do not need to outsource all the cloud infrastructure management activities, our
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-1xl md:text-2xl font-bold">Cloud infrastructure security</h1>
                    <p class=" text-xl md:text-2xl mt-4">
                        As a Gold Microsoft Business Partner equipped with the competencies in Cloud Platform, Data
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-3xl md:text-2xl font-bold">Cloud migration</h1>

                    <p class=" text-xl md:text-2xl mt-6">
                        ScienceSoft’s team can perform a full-scale migration of your on-premises IT infrastructure
        ...
        <p class="text-lg">
            ScienceSoft’s IT infrastructure team is experienced in a wide range of data center services – we cover
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-1xl md:text-2xl font-bold">Data center management</h1>
                    <p class=" text-xl md:text-2xl mt-4">
                        Our data center experts are ready to make your data center operational capabilities meet
                    ...
                    <p class="text-xl my-4">
                        ScienceSoft’s data center management services include:
                    </p>
                    <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
                        <li class="my-4">Installing and properly configuring servers, storage and network
                            appliances, and other data center components. </li>
                        <li class="mb-4">Managing data center workflows.
                        </li>
                        <li class="mb-4">Retiring or adding data center components if needed.
                        </li>
                        <li class="mb-4">Carrying out the migration of an on-premises data center to the cloud with
                            the minimal downtime. </li>
                        <li>
                            Managing regular enhancements of data center components (servers, storage, networking
                        ...
                        <li>
                            Providing the security of your data center and regularly performing backups to ensure
                        ...
                        <li>
                            Ensuring a complete transparency over the data center components, e.g., computers,
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-1xl md:text-2xl font-bold">Data center monitoring</h1>
                    <p class=" text-xl md:text-2xl mt-4">
                        If you do not feel like outsourcing all the set of data center management activities,
                    ...
                    <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
                        <li class="my-4">Ongoing monitoring of Windows, Linux servers and computer systems to ensure
                            they perform properly and avoid unplanned downtimes. </li>
                        <li class="mb-4">Monitoring of data center operations and predicting or quickly addressing
        ...
        <p class="text-lg my-4">
            By applying DevOps practices and techniques, such as continuous integration and continuous delivery
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-1xl md:text-2xl font-bold"><a href="#">DevOps consulting</a></h1>
                    <p class=" text-xl md:text-2xl mt-4">
                        ScienceSoft’s team helps apply the DevOps approach to:
                    </p>
                    <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
                        <li class="my-4">Automate and accelerate the provision of a new infrastructure for a new
                            software development project due to the use of IaC approach.</li>
                        <li class="mb-4">Align the development and testing environments with the production to avoid
                            the differences between their configurations and software failures on production.
                        </li>
                        <li>
                            Speed up infrastructure modifications, software updates and bug fixing due to the
        ...
        <div class="rounded-sm p-2 md:p-8">
            <div class="flex flex-col md:flex-row  items-start">
                ...
                <div class=" flex flex-col w-3/5">
                    <h1 class="text-1xl md:text-2xl font-bold">DevOps implementation</h1>
                    <p class=" text-xl md:text-2xl mt-4">
                        ScienceSoft’s team provides you with the end-to-end service aimed at the faultless
                        implementation of the DevOps approach. Taking into account your business needs and
                        requirements, we:
                    </p>
                    <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
                        <li class="my-4">Develop a comprehensive strategy for the implementation of the DevOps
                            approach.</li>
                        <li class="mb-4">Set up and configure DevOps tools for containerization (Kubernetes,
                            Ansible), CI/CD (GoCD, Jenkins), IT automation (Terraform, Chef), application monitoring
                            (Prometheus, Zabbix).
                        </li>
                        <li>
                            Launch your DevOps initiative avoiding downtimes and provide you with after-launch
        ...
        <h1 class="text-3xl font-bold">
            Virtual desktop infrastructure (VDI) services: consulting, implementation and support
        </h1>
        <p class="text-lg my-4">
            ScienceSoft’s experts are ready to offer you their experience in desktop virtualization consulting,
        ...
        <ul class="list-outside list-disc bg-rose-200 text-lg leading-relaxed">
            <li class="my-4">Get a comprehensive evaluation of your company’s organizational and operational needs
                and determine the suitable approach for desktop infrastructure virtualization.</li>
            <li class="mb-4">Ensure centralized and thus simplified management of the data, applications within the
                virtual desktops.
            </li>
            <li>
                Increase your users’ performance.
            </li>
            <li>
                Deliver portable, centrally managed desktops to your internal or external users.
            </li>
            <li>
                Enhance the security of the virtual desktops due to centralization.
            </li>
            <li>
                Achieve your corporate data integrity due to its regular backups.
            </li>
            <li>
                Promptly eliminate any issue related to the performance of your VDI, regardless of the desktop
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl mt-20'>
            <div class='w-2/3'>
                ...
                <p class='text-gray-600 text-xl'>We will develop a scalable solution with neat UX design that
                    answers your business needs.</p>
            </div>
            <div class='w-1/3 m-0 flex justify-center items-center'>
                <a href="#" class='px-8 py-3 bg-blue-700 text-white uppercase hover:bg-blue-900'>Get a Free
                    Consulation</a>
            </div>
        </div>
        <div>
            ...
            <div class="rounded-sm bg-gray-50 relative mt-10 transition-shadow p-2 md:p-8">
                <div class="flex flex-col md:flex-row items-center ">
                    ...
                    <div class=" flex flex-col w-5/6 mb-10">
                        <h1 class="text-xl md:text-2xl font-bold">Development of Invention Machine Software with
                            Semantic Search</h1>
                        <hr class="w-12 border-yellow-600 text-gray-800 my-4">
                        <p class=" text-gray-500 text-lg md:text-xl">
                            ScienceSoft successfully introduced the DevOps approach and implemented CI/CD pipeline
