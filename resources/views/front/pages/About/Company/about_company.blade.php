...
@section('main')
    ...
    <div class="my-10 rounded-sm border-2 transition-shadow m-20 hover:shadow-xl p-2 md:p-8">
    ...
    <div class="m-20">
        ...
        <div class="">
            ...
            <p class="text-xl my-8">
                We collaborate with companies from 37 countries and have 76% of our revenue generated from contracts lasting
                for
            ...
            <p class="text-xl my-8">
                During our practice, we acquired expertise and a deep understanding of business models and processes across
                23
        ...
        <div>
            <div class="my-6 rounded-sm border-2 transition-shadow hover:shadow-xl p-2 md:p-8">
                <div class="flex flex-col md:flex-row  items-start">
                    ...
                    <div class=" flex flex-col w-full">
                        ...
                        <hr class="w-12 border-yellow-600 text-gray-800 my-4">
                        <p class="text-xl">
                            We follow a corporate quality management system established in 2007. According to it, we set up
                            risk
            ...
            <div class="my-6 rounded-sm border-2 transition-shadow hover:shadow-xl p-2 md:p-8">
                <div class="flex flex-col md:flex-row  items-start">
                    ...
                    <div class=" flex flex-col w-full">
                        <h1 class="text-3xl md:text-4xl font-bold">Fast development while retaining application stability
                        </h1>
                        <hr class="w-12 border-yellow-600 text-gray-800 my-4">
                        <p class="text-xl">
        ...
        <div class='flex justify-between items-center p-10 shadow-2xl my-20'>
            <div class='w-2/3'>
                <h1 class='text-gray-900 mt-6'>
                    <p class='text-2xl font-bold'>Looking for a Partner to Support Your Business Growth or Monetize Your
                        Idea?
                    </p>
                    <hr class="border-t-2 w-12 border-yellow-600 mt-4 mb-4">
                </h1>
