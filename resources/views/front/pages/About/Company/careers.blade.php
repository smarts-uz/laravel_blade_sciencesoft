  ...
  <div class=" flex flex-col lg:flex-row my-10 mx-6 md:mx-16 lg:mx-24">
    <div class="w-full lg:w-1/3  lg:flex flex-col mr-3">
      ...
      <div class="text-gray-600 w-full cursor-pointer hover:text-blue-600 mb-4">
        <p class="border-b-2 py-1 uppercase font-bold border-gray-500 hover:border-blue-600">{{ _trans("Careers")  }}</p>
      </div>
    ...
    <div class="w-full lg:w-2/3">
      <div class="px-1 md:px-8 lg:px-12 flex flex-col">
        ...
        <h1 class="py-6 border-gray-500 border-b text-blue-600 font-bold text-3xl md:text-4xl my-3">{{ _trans("Careers at ScienceSoft")  }}</h1>
        <h1 class="py-6 border-gray-500 border-b text-blue-600 font-bold text-2xl md:text-3xl mt-6 mb-3">{{ _trans("Software Development Department")  }}</h1>
        <ul class="flex flex-col">
            ...
            <div id="dropdown-one" class="hidden flex-col mt-2 ml-10">
              ...
              <ul style="list-style: square;" class="flex flex-col text-sm lg:text-xl">
                <li class="text-blue-600">
                  <span class="text-gray-600">{{ _trans("Srtong knowledge of React, React Native,")  }}</span>
                </li>
                <li class="text-blue-600">
                  <span class="text-gray-600">{{ _trans("Srtong knowledge of Redux/Flux, JavaScript, TypeScript, HTML5, CSS3, SASS/LESS, Responsive design;")  }}</span>
                </li>
                <li class="text-blue-600">
                  <span class="text-gray-600">{{ _trans("Srtong knowledge of React, React Native,")  }}</span>
                </li>
