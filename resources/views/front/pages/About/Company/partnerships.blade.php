...
@section('main')
        ...
        <div class="w-full mx-6 lg:mr-24 lg:mx-10">
            ...
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center">
                ...
                <div class="md:w-8/12 text-xl md:text-left leading-relaxed text-gray-500 p-3 text-center w-full">
                    <p class="">
                        An Oracle Partner since 2007, ScienceSoft provides end-to-end business intelligence solutions, including data warehouse implementation, predictive analytics, reporting, OLAP and visualization.</p>
                </div>
            </div>
            <!-- ============================= -->
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center">
            ...
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center items-center">
                ...
                <div class="md:w-8/12 text-xl md:text-left leading-relaxed text-gray-500 p-3 text-center w-full">
                    <p class="">
                    <p class="">
                        An Adobe Commerce Cloud partner, ScienceSoft helps businesses secure the viability of their business model in the digital age and shift their operations online to serve customers globally. Since 2003, our team has been designing ecommerce solutions and web portals for businesses in retail, manufacturing, healthcare, education, and other industries. Powered by Adobe technologies, we build highly automated and effective digital solutions.</p>
                </div>
            </div>
            <!-- ============================= -->
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center items-center">
            ...
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center items-center">
                ...
                <div class="md:w-8/12 text-xl md:text-left leading-relaxed text-gray-500 p-3 text-center w-full">
                    <p class="">
                        Since 2008, ScienceSoft has been successfully delivering industry-specific CRM and CXM solutions to customers in Healthcare, Retail, Telecommunications, Banking, and Manufacturing. As a <a href="#" class="underline">Salesforce Registered Consulting Partner,</a>ScienceSoft provides its customers with tailor-made solutions based on the best-in-class platform</p>
                </div>
            </div>
            <!-- ============================= -->
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center items-center">
                ...
                <div class="md:w-8/12 text-xl md:text-left leading-relaxed text-gray-500 p-3 text-center w-full">
                    <p class="">
                        ScienceSoft is a member of the <b> Citrix Partner</b> network as a<b> Silver Solution Advisor</b> since 2018 with Citrix-accredited in-house professionals. ScienceSoft’s team holds a total of <b> 16 Citrix certificates,</b> including Citrix Consulting Methodology and Project Management, Citrix Certified Sales Professional (CCSP-019), Leveraging Citrix Sales Tools, Important Revenue Recognition and Legal Considerations, Think Like a Support Engineer, etc.</p>
                </div>
            </div>
            <!-- ============================= -->
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center items-center">
                ...
                <div class="md:w-8/12 text-xl md:text-left leading-relaxed text-gray-500 p-3 text-center w-full">
                    <p class="">
                        Kyubit Business Intelligence partner
            ...
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center items-center">
                ...
                <div class="md:w-8/12 text-xl md:text-left leading-relaxed text-gray-500 p-3 text-center w-full">
                    <p class="">
                        As Services Partner of OpenText, ScienceSoft has been using StreamServe to help companies in Telecommunications, Retail, Banking and other industries benefit from powerful document management capabilities.
                    </p>
                </div>
            </div>
            <!-- ============================= -->
            <div class="md:w-full flex my-5 py-5 xl:flex-row flex-col justify-center items-center">
                ...
                <div class="md:w-8/12 text-xl md:text-left leading-relaxed text-gray-500 p-3 text-center w-full">
                    <p class="">
                        A long-term partner of ScienceSoft, Ispirer offers cross-platform database migration, embedded SQL/Database API Migration and application conversion. The company focuses on custom and automated conversion of SQL languages.
                    </p>
                </div>
            </div>
            <!-- ============================= -->
