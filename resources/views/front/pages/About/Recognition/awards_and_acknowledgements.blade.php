...
@section('main')
    ...
    <div>
        <div class="mx-6 sm:mx-16 lg:mx-18 ">
            <div class="my-4">
                <h1 class="uppercase font-extrabold text-3xl pb-4">ScienceSoft’s Awards and Recognitions</h1>
            ...
            <div class="text-lg my-10">
                <p>
                    For over 31 years, ScienceSoft has supported businesses with high-quality IT services. We help
                ...
                <p class="mt-8">
                    We take pride in being consistently recognized by independent organizations as a trusted and reliable IT
            ...
            <div class="grid grid-cols-3 ">
                <div class="flex flex-row mt-6 col-span-2 ">
                    ...
                    <ul class="list-disc text-base md:text-xl leading-loose col">
                        <li class="mb-4">
                            Clutch featured ScienceSoft in the list of Top IT Services Firms and Top 1000 B2B Providers
                            Globally, as well as named us No.1 in the lists Top AWS Partners, Top Azure Consultants, Top
                            Salesforce Consultants.
                        </li>
                        <li class="text-base mb-4 ">
                            Clutch is known as the premier ratings and reviews platform for buyers of B2B services. Its
                            unbiased ranking is based on a unique methodology that incorporates multiple data points to
                            compare industry leaders.
                        </li>
                        <li class="mb-4">
                            International Association of Outsourcing Professionals (IAOP) selected ScienceSoft for the
                        ...
                        <li class="mb-4">
                            TechReviewer put ScienceSoft first in the list of Leading QA and Software Testing Companies.
                        ...
                        <li>
                            UpFirms.com included ScienceSoft is the list of Top Web Development Companies.
                ...
                <div class="flex flex-col md:flex-row  items-start">
                    ...
                    <div class=" flex flex-col w-3/5">
                        ...
                        <div class="text-xl">
                            ...
                            <p>
                                QLEAN is an off-the-shelf automated tuning, optimization and health assessment tool that
                ...
                <div class="flex flex-col md:flex-row  items-start">
                    ...
                    <div class=" flex flex-col w-3/5">
                        ...
                        <div class="text-xl">
                            ...
                            <p>
                                Infobank.by is a financial and analytical portal covering all major events from the world of
