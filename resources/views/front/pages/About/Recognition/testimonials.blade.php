...
<div class="block p-4 m-auto" style="max-width: 1150px;">
            <div class="card w-full my-4">
                ...
                <p class="text-gray-600 text-md leading-7 md:leading-8 lg:leading-9 md:text-lg lg:text-xl">
                    {{ _trans("We collaborate with companies from")  }} <strong>37 {{ _trans("countries")  }}</strong> {{ _trans("and")  }} <strong>23 {{ _trans("industries")  }}</strong>.
                    {{ _trans("Our project portfolio includes")  }} <strong>2,695 {{ _trans("success stories")  }}</strong>, {{ _trans("including projects
            ...
            <div class="card my-6 lg:flex">
                ...
                <div class="lg:flex-row lg:w-1/2">
                    <h1 class="text-2xl lg:3xl text-gray-800 font-bold">{{ _trans("Leo Burnett Worldwide: What Is Working with ScienceSoft Like")  }}</h1>
                <hr class="w-12 my-3 border-b-2 bg-yellow-300">
