...
<div class="block p-4">
                ...
                <div class="user-info flex flex-wrap">
                    <div class="user flex-column md:flex content-center w-full md:w-2/5 my-4 mr-9">
                        ...
                        <div class="text flex-column mt-6">
                            <a href="#" class="text-blue-700 underline"><p class="font-bold hover:text-blue-700 text-lg mg:xl text-gray-800">{{ _trans("Boris Shiklo:")  }}</p></a>
                    ...
                    <div class="user flex-column md:flex content-center w-full md:w-2/5 my-4 mr-9">
                        ...
                        <div class="text flex-column mt-6">
                            <a href="#" class="text-blue-700 underline"><p class="font-bold hover:text-blue-700 text-lg mg:xl text-gray-800">{{ _trans("Alex Bekker:")  }}</p></a>
                            <p class="my-4 text-md text-gray-600">
                    ...
                    <div class="user flex-column md:flex content-center w-full md:w-2/5 my-4 mr-9">
                        ...
                        <div class="text flex-column mt-6">
                            <a href="#" class="text-blue-700 underline"><p class="font-bold hover:text-blue-700 text-lg mg:xl text-gray-800">{{ _trans("Uladzislau Murashka:")  }}</p></a>
                            <p class="my-4 text-md text-gray-600">
                    ...
                    <div class="user flex-column md:flex content-center w-full md:w-2/5 my-4 mr-9">
                        ...
                        <div class="text flex-column mt-6">
                            <a href="#" class="text-blue-700 underline"><p class="font-bold hover:text-blue-700 text-lg mg:xl text-gray-800">{{ _trans("Sergey Golubenko:")  }}</p></a>
                            <p class="my-4 text-md text-gray-600">
                    ...
                    <div class="user flex-column md:flex content-center w-full md:w-2/5 my-4 mr-9">
                        ...
                        <div class="text flex-column mt-6">
                            <a href="#" class="text-blue-700 underline"><p class="font-bold hover:text-blue-700 text-lg mg:xl text-gray-800">{{ _trans("Vadim Belski:")  }}</p></a>
                            <p class="my-4 text-md text-gray-600">
                    ...
                    <div class="user flex-column md:flex content-center w-full md:w-2/5 my-4 mr-9">
                        ...
                        <div class="text flex-column mt-6">
                            <a href="#" class="text-blue-700 underline"><p class="font-bold hover:text-blue-700 text-lg mg:xl text-gray-800">{{ _trans("Andrei Mikhailau:")  }}</p></a>
                            <p class="my-4 text-md text-gray-600">
            ...
            <div class="card w-full p-4">
                ...
                <ul style="list-style: square;" class="text-blue-700 m-6">
                    <li class="text-md md:text-lg text-gray-600">{{ _trans("Our CTO, Boris Shiklo, shared his proficient opinion on IT compliance issues for an")  }} <a href="#" class="text-blue-700 underline">{{ _trans("article")  }}</a> {{ _trans("on")  }} CIO.com.</li>
                    <li class="text-md md:text-lg text-gray-600">{{ _trans("Our IoT expert was invited to participate in")  }} <a href="#" class="text-blue-700 underline">{{ _trans("research on Smart Cities.")  }}</a></li>
                    <li class="text-md md:text-lg text-gray-600">{{ _trans("Our IT security professional Uladzislau Murashka was")  }} <a href="#" class="text-blue-700 underline">{{ _trans("featured on Digital Guardian blog.")  }}</a></li>
                </ul>
            </div>
            <div class="card w-full p-4">
                ...
                <ul style="list-style: square;" class="text-blue-700 m-6">
                    <li class="text-md md:text-lg text-gray-600">{{ _trans("Require competent commentary on IT problems.")  }}</li>
                    <li class="text-md md:text-lg text-gray-600">{{ _trans("Need any tech-related information for your article.")  }}</li>
                    <li class="text-md md:text-lg text-gray-600">{{ _trans("Want to interview one of our experts.")  }}</li>
                    <li class="text-md md:text-lg text-gray-600">{{ _trans("Would like to quote any research from our articles.")  }}</li>
                </ul>
                <p class="text-md leading-normal md:text-lg text-gray-600 my-6">
                    ...
                    <a href="#" class="underline text-blue-700">press@scnsoft.com</a> {{ _trans("or call us at")  }} +1 214 306 68 37. {{ _trans("We will process your request")  }}
