    ...
    <div class="wrapper">
      ...
      <div class="flex">
        <div class="container mx-auto justify-between max-w-7xl">
          <h2 class="pl-2 py-5 text-7xl">{{ @translate_lang("Contact Us")  }}</h2>
          ...
          <div class="md:flex-row w-full bg-gray-200 justify-between flex flex-row flex-col">
            <div class="md:w-4/12 w-full bg-white">
              <h2 class="font-bold text-center text-2xl pt-5">{{ @translate_lang("ScienceSoft in brief")  }}</h2><br>
              <div class="flex">
                <i class="text-2xl fas fa-check text-green-600 pl-6 pr-3 py-3"></i>
                <p class="text-lg py-3"><span class="font-semibold">{{ @translate_lang("31 years")  }}</span>{{ @translate_lang(" in IT.")  }}</p>
              </div>
              <!-- -------------------------------------------- -->
              <div class="flex">
                <i class="text-2xl fas fa-check text-green-600 pl-6 pr-3 py-3"></i>
                <p class="text-lg py-3">{{ @translate_lang("Over")  }}<span class="font-semibold">{{ @translate_lang("700 specialists")  }}</span>{{ @translate_lang("on board.")  }}</p>
              </div>
              <!-- -------------------------------------------- -->
              <div class="flex">
                <i class="text-2xl fas fa-check text-green-600 pl-6 pr-3 py-3"></i>
                <p class="text-lg py-3">{{ @translate_lang("700-employee business")  }}<span class="font-semibold">{{ @translate_lang("partner network.")  }}</span></p>
              </div>
              <!-- -------------------------------------------- -->
            ...
            <div class="md:w-8/12 w-full min-h-96">
              <p class="text-center text-lg pt-5 text-gray-400">{{ @translate_lang("Drop us a line, and our rep will contact you
              ...
              <form action="" class="w-full flex-col">
                <div class="m-3 flex justify-around pb-5">
                  <input class="p-3 w-2/4 mx-2 border-solid border-2 border-black" type="text" id="" name=""
                    placeholder="{{ @translate_lang("Full Name")  }}">
                  <input class="p-3 w-2/4 mx-2 border-solid border-2 border-black" type="text" id="" name=""
                    placeholder="{{ @translate_lang("Company")  }}">
                </div>
                <div class="m-3 flex justify-around">
                  <input class="p-3 w-2/4 mx-2 border-solid border-2 border-black" type="text" id="" name=""
                    placeholder="{{ @translate_lang("Work Email")  }}">
                  <input class="p-3 w-2/4 mx-2 border-solid border-2 border-black" type="text" id="" name=""
                    placeholder="{{ @translate_lang("Work Phone")  }}">

                </div>

                <div class="m-3 flex items-center ">
                  <textarea class="flex  p-3 w-full  mx-2 border-solid border-2 border-black" name="" id="" cols="30" rows="4"
                    placeholder="{{ @translate_lang("Comments")  }}"></textarea>
                </div>

                <div class="text-center">
                  <input id="upload" class="hidden" type="file">
                  <span><label class="cursor-pointer" for="upload"><i class="fas fa-paperclip"></i></label>
                  {{ @translate_lang(" Drag & Drop file here or")  }}</span>
                  <label class="text-blue-700 cursor-pointer" for="upload">{{ @translate_lang("browse a file")  }}</label>
                ...
                <div class="w-full flex items-center justify-center py-5">
                  ...
                  {{ @translate_lang(" Discuss my needs")  }}</button>
                </div>
              </form>
            </div>
          </div>
