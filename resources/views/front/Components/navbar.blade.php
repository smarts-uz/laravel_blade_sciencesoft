      ...
      <ul class="flex-col w-56">
       ...
       <span onclick="closedropdownAbout()" class="hidden arrowUpAbout">
        ...
        <ul class="dropdown-container-about hidden flex-col mt-6 ml-4">
          ...
          <a href="{{route('getBlade', 'about.company.about_company')}}"><li class="mt-4">{{ _trans("About Company")  }}</li></a>
        ...
        <div class="flex items-center justify-between mt-4 cursor-pointer">
          <li id="services" class="relative">{{ _trans("Services")  }}</li>
          ...
          <ul class="dropdown-container-Services hidden flex-col mt-6 ml-4">
            ...
            <hr class="border-b-2 w-12 border-yellow-500">
            <a href="#"><li class="mt-4">{{ _trans("Software Development")  }}</li></a>
        ...
        <ul class="w-11/12 hidden lg:flex justify-end items-center font-semibold list-none uppercase text-black">
          <li class="flex mr-8 border-white hover:border-blue-700 cursor-pointer hover:text-blue-500">
            ...
            <div id="aboutHover" class=" hidden flex absolute left-0 z-40 justify-evenly top-20 border-t-2 border-b-2 bg-white items-start">
              ...
              <div class="w-1/5 list-none">
                ...
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("About Company")  }}</li></a>
              ...
              <div class="w-1/5 list-none">
                ...
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Management Team")  }}</li>
          ...
          <li id="services" class="mr-8 cursor-pointer z-40 hover:text-blue-500">
            ...
            <div id="serviceHover" class="hidden flex absolute left-0  justify-evenly top-20 border-t-2 border-b-2 bg-white items-start py-6">
              <div class="w-1/6">
                <h1 class="mb-2 font-extrabold">{{ _trans("Services")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <p class="mt-4 text-black font-normal">
                  {{ _trans("We handle complex business challenges building all types of custom and platform-based solutions and providing a comprehensive set of end-to-end IT services.")  }}</p>
                <p class="font-extrabold mt-4 text-black">{{ _trans("Can't find what you need?")  }}</p>
              ...
              <div class="w-1/6 list-none">
                <h1 class="mb-2 font-extrabold">
                  {{ _trans("Service types")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Software Development")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Testing and QA")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Application Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("UI/UX Design")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Infrastructure Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Managed IT Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("IT Outsourcing")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("IT Consulting")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("IT Support")  }}</li></a>
              </ul>
              </div>
              <div class="w-1/6 list-none">
                <h1 class="mb-2  font-extrabold">{{ _trans("Solutions")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Data Analytics")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("CRM")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Cybersecurity")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Internet of Things")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Web Portals")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Ecommerce")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Fleet Management")  }}</li></a>
              </ul>
              </div>
              <div class="w-1/6 list-none">
                <h1 class="mb-2  font-extrabold">{{ _trans("Platforms")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("SharePoint and Office 365")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Microsoft Dynamics 365")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Microsoft Power BI")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Salesforce")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Magento")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("ServiceNow")  }}</li></a>
                </ul>
              </div>
              <div class="w-1/6 list-none">
                <h1 class="mb-2  font-extrabold">{{ _trans("Technologies")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Java")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans(".NET")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("PHP")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Python")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Golang")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("C++")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Configure Your Team")  }}</li></a>
                </ul>
              </div>
            </div>
          </a>
          ...
          <li id="industries" class="mr-8 cursor-pointer z-40 hover:text-blue-500">
            ...
            <div id="industryHover" class="hidden flex absolute left-0  justify-between top-20 border-t-2 border-b-2 bg-white items-start py-6">
              ...
              <div class="w-1/4 list-none">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Healthcare")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Banking and Financial Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Retail")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Ecommerce")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Manufacturing")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Marketing & Advertising")  }}</li></a>
              </ul>
              </div>
              <div class="w-1/4 list-none">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Telecommunications")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("eLearning")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Transportation and Logistics")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Oil and Gas")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Professional Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ _trans("Insurance")  }}</li></a>
              </ul>
              </div>
            </div>
            </a>
