      ...
      <ul class="flex-col w-56">
       ...
       <span onclick="closedropdownAbout()" class="hidden arrowUpAbout">
        ...
        <ul class="dropdown-container-about hidden flex-col mt-6 ml-4">
          ...
          <a href="{{route('getBlade', 'about.company.about_company')}}"><li class="mt-4">{{ t("About Company")  }}</li></a>
        ...
        <div class="flex items-center justify-between mt-4 cursor-pointer">
          <li id="services" class="relative">{{ t("Services")  }}</li>
          ...
          <ul class="dropdown-container-Services hidden flex-col mt-6 ml-4">
            ...
            <hr class="border-b-2 w-12 border-yellow-500">
            <a href="#"><li class="mt-4">{{ t("Software Development")  }}</li></a>
        ...
        <ul class="w-11/12 hidden lg:flex justify-end items-center font-semibold list-none uppercase text-black">
          <li class="flex mr-8 border-white hover:border-blue-700 cursor-pointer hover:text-blue-500">
            ...
            <div id="aboutHover" class=" hidden flex absolute left-0 z-40 justify-evenly top-20 border-t-2 border-b-2 bg-white items-start">
              <div class="w-1/5">
                ...
                <div class="bg-blue-700 px-6 py-2 text-white w-36 text-center"><a href="#">{{ t("ASK US")  }}</a></div>
              </div>
              <div class="w-1/5 list-none">
                <h1 class="mb-2 font-extrabold">{{ t("Company")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("About Company")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Management Team")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Careers")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Partnerships")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Smart SoftwareReferral Program")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Our Locations")  }}</li></a>
              </ul>
              </div>
              <div class="w-1/5 list-none">
              ...
              <div class="w-1/5 list-none">
                ...
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Management Team")  }}</li>
          ...
          <li id="services" class="mr-8 cursor-pointer z-40 hover:text-blue-500">
            ...
            <div id="serviceHover" class="hidden flex absolute left-0  justify-evenly top-20 border-t-2 border-b-2 bg-white items-start py-6">
              <div class="w-1/6">
                <h1 class="mb-2 font-extrabold">{{ t("Services")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <p class="mt-4 text-black font-normal">
                  {{ t("We handle complex business challenges building all types of custom and platform-based solutions and providing a comprehensive set of end-to-end IT services.")  }}</p>
                <p class="font-extrabold mt-4 text-black">{{ t("Can't find what you need?")  }}</p>
              ...
              <div class="w-1/6 list-none">
                ...
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Software Development")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Testing and QA")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Application Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("UI/UX Design")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Infrastructure Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Managed IT Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("IT Outsourcing")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("IT Consulting")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("IT Support")  }}</li></a>
              </ul>
              </div>
              <div class="w-1/6 list-none">
                <h1 class="mb-2  font-extrabold">{{ t("Solutions")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Data Analytics")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("CRM")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Cybersecurity")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Internet of Things")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Web Portals")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Ecommerce")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Fleet Management")  }}</li></a>
              </ul>
              </div>
              <div class="w-1/6 list-none">
                <h1 class="mb-2  font-extrabold">{{ t("Platforms")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("SharePoint and Office 365")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Microsoft Dynamics 365")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Microsoft Power BI")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Salesforce")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Magento")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("ServiceNow")  }}</li></a>
                </ul>
              </div>
              <div class="w-1/6 list-none">
                <h1 class="mb-2  font-extrabold">{{ t("Technologies")  }}</h1>
                <hr class="border-b-2 w-12 border-yellow-500">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Java")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t(".NET")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("PHP")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Python")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Golang")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("C++")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Configure Your Team")  }}</li></a>
                </ul>
              </div>
            </div>
          </a>
          ...
          <li id="industries" class="mr-8 cursor-pointer z-40 hover:text-blue-500">
            ...
            <div id="industryHover" class="hidden flex absolute left-0  justify-between top-20 border-t-2 border-b-2 bg-white items-start py-6">
              ...
              <div class="w-1/4 list-none">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Healthcare")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Banking and Financial Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Retail")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Ecommerce")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Manufacturing")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Marketing & Advertising")  }}</li></a>
              </ul>
              </div>
              <div class="w-1/4 list-none">
                <ul>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Telecommunications")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("eLearning")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Transportation and Logistics")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Oil and Gas")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Professional Services")  }}</li></a>
                <a href="#"><li class="mt-4 text-black hover:text-blue-700">{{ t("Insurance")  }}</li></a>
              </ul>
              </div>
            </div>
            </a>
