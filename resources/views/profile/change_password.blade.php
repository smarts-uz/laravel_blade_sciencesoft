            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <label>{{ t("Current Password:")  }}</label><span
                    ...
                    <div class="form-group col-sm-12">
                        <label>{{ t("New Password:")  }}</label><span
                                class="required confirm-pwd"></span><span class="required">*</span>
                        <div class="input-group">
                    ...
                    <div class="form-group col-sm-12">
                        <label>{{ t("Confirm Password:")  }}</label><span
                                class="required confirm-pwd"></span><span class="required">*</span>
                        <div class="input-group">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary" id="btnPrPasswordEditSave" data-loading-text="<span class='spinner-border spinner-border-sm'></span> Processing...">{{ t("Save")  }}</button>
