...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $categories=[
            ...
            ['id'=>56, 'name' => 'Healthcare', 'category_id'=>3, 'path_blade'=>'industries.healthcare'],
            ['id'=>57, 'name' => 'Banking and Financial Services', 'category_id'=>3, 'path_blade'=>'industries.banking_financial_services'],
            ['id'=>58, 'name' => 'Retail', 'category_id'=>3, 'path_blade'=>'industries.retail'],
            ['id'=>59, 'name' => 'Ecommerce', 'category_id'=>3, 'path_blade'=>'industries.ecommerce'],
            ['id'=>60, 'name' => 'Manufacturing', 'category_id'=>3, 'path_blade'=>'industries.manufacturing'],
            ['id'=>61, 'name' => 'Marketing & Advertising', 'category_id'=>3, 'path_blade'=>'industries.market_advertising'],
            ['id'=>62, 'name' => 'Telecommunications', 'category_id'=>3, 'path_blade'=>'industries.telecommunications'],
            ['id'=>63, 'name' => 'eLearning', 'category_id'=>3, 'path_blade'=>'industries.elearning'],
            ['id'=>64, 'name' => 'Transportation and Logistics', 'category_id'=>3, 'path_blade'=>'industries.transportation_logistics'],
            ['id'=>65, 'name' => 'Oil & Gas', 'category_id'=>3, 'path_blade'=>'industries.oil_gas'],
            ['id'=>66, 'name' => 'Professional Services', 'category_id'=>3, 'path_blade'=>'industries.professional_services'],
            ['id'=>67, 'name' => 'Insurance', 'category_id'=>3, 'path_blade'=>'industries.insurance'],
